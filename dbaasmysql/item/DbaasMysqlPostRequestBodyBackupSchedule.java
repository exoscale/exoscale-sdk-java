...
public class DbaasMysqlPostRequestBodyBackupSchedule implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasMysqlPostRequestBodyBackupSchedule and sets the default values.
     */
    public DbaasMysqlPostRequestBodyBackupSchedule() {
    ...
    public static DbaasMysqlPostRequestBodyBackupSchedule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasMysqlPostRequestBodyBackupSchedule();
    }
    /**
