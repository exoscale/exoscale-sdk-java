...
public enum SksClusterAddons implements ValuedEnum {
    ...
    SksClusterAddons(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static SksClusterAddons forValue(@jakarta.annotation.Nonnull final String searchValue) {
