...
public class Migration {
     ...
     * Hostname or IP address of the server where to migrate data from
     */
    public Migration withHost(String host) {
        Utils.checkNotNull(host, "host");
        this.host = host;
        return this;
    }
     ...
     * Port number of the server where to migrate data from
     */
    public Migration withPort(long port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }
     ...
     * Password for authentication with the server where to migrate data from
     */
    public Migration withPassword(String password) {
        Utils.checkNotNull(password, "password");
     ...
     * Password for authentication with the server where to migrate data from
     */
    public Migration withPassword(Optional<? extends String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
     ...
     * The server where to migrate data from is secured with SSL
     */
    public Migration withSsl(boolean ssl) {
        Utils.checkNotNull(ssl, "ssl");
     ...
     * The server where to migrate data from is secured with SSL
     */
    public Migration withSsl(Optional<? extends Boolean> ssl) {
        Utils.checkNotNull(ssl, "ssl");
        this.ssl = ssl;
        return this;
    }
     ...
     * User name for authentication with the server where to migrate data from
     */
    public Migration withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * User name for authentication with the server where to migrate data from
     */
    public Migration withUsername(Optional<? extends String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * Database name for bootstrapping the initial connection
     */
    public Migration withDbname(String dbname) {
        Utils.checkNotNull(dbname, "dbname");
     ...
     * Database name for bootstrapping the initial connection
     */
    public Migration withDbname(Optional<? extends String> dbname) {
        Utils.checkNotNull(dbname, "dbname");
        this.dbname = dbname;
        return this;
    }
     ...
     * Comma-separated list of databases, which should be ignored during migration (supported by MySQL only at the moment)
     */
    public Migration withIgnoreDbs(String ignoreDbs) {
        Utils.checkNotNull(ignoreDbs, "ignoreDbs");
     ...
     * Comma-separated list of databases, which should be ignored during migration (supported by MySQL only at the moment)
     */
    public Migration withIgnoreDbs(Optional<? extends String> ignoreDbs) {
        Utils.checkNotNull(ignoreDbs, "ignoreDbs");
        this.ignoreDbs = ignoreDbs;
        return this;
    }

    public Migration withMethod(com.exoscale.api.models.components.EnumMigrationMethod method) {
        Utils.checkNotNull(method, "method");
        this.method = Optional.ofNullable(method);
        return this;
    }

    public Migration withMethod(Optional<? extends com.exoscale.api.models.components.EnumMigrationMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Migration.class,
                "host", host,
                "port", port,
                "password", password,
                "ssl", ssl,
