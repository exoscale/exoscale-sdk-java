...
public class CreateDbaasServiceMysqlBackupSchedule {
    ...
    public CreateDbaasServiceMysqlBackupSchedule(
     ...
     * The hour of day (in UTC) when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServiceMysqlBackupSchedule withBackupHour(long backupHour) {
        Utils.checkNotNull(backupHour, "backupHour");
     ...
     * The hour of day (in UTC) when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServiceMysqlBackupSchedule withBackupHour(Optional<? extends Long> backupHour) {
        Utils.checkNotNull(backupHour, "backupHour");
        this.backupHour = backupHour;
        return this;
    }
     ...
     * The minute of an hour when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServiceMysqlBackupSchedule withBackupMinute(long backupMinute) {
        Utils.checkNotNull(backupMinute, "backupMinute");
     ...
     * The minute of an hour when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServiceMysqlBackupSchedule withBackupMinute(Optional<? extends Long> backupMinute) {
        Utils.checkNotNull(backupMinute, "backupMinute");
        this.backupMinute = backupMinute;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateDbaasServiceMysqlBackupSchedule other = (CreateDbaasServiceMysqlBackupSchedule) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateDbaasServiceMysqlBackupSchedule.class,
    ...
    public final static class Builder {
        ...
        public CreateDbaasServiceMysqlBackupSchedule build() {
            return new CreateDbaasServiceMysqlBackupSchedule(
                backupHour,
                backupMinute);
        }
    }
