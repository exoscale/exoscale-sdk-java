...
public class DbaasOpensearchPostRequestBodyIndexTemplate implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasOpensearchPostRequestBodyIndexTemplate and sets the default values.
     */
    public DbaasOpensearchPostRequestBodyIndexTemplate() {
    ...
    public static DbaasOpensearchPostRequestBodyIndexTemplate createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasOpensearchPostRequestBodyIndexTemplate();
    }
    /**
