...
public class DbaasServiceOpensearchComponents {
     ...
     * Service component name
     */
    public DbaasServiceOpensearchComponents withComponent(String component) {
        Utils.checkNotNull(component, "component");
        this.component = component;
        return this;
    }
     ...
     * DNS name for connecting to the service component
     */
    public DbaasServiceOpensearchComponents withHost(String host) {
        Utils.checkNotNull(host, "host");
        this.host = host;
        return this;
    }
     ...
     * Port number for connecting to the service component
     */
    public DbaasServiceOpensearchComponents withPort(long port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }

    public DbaasServiceOpensearchComponents withRoute(EnumComponentRoute route) {
        Utils.checkNotNull(route, "route");
        this.route = route;
        return this;
    }

    public DbaasServiceOpensearchComponents withUsage(EnumComponentUsage usage) {
        Utils.checkNotNull(usage, "usage");
        this.usage = usage;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DbaasServiceOpensearchComponents other = (DbaasServiceOpensearchComponents) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DbaasServiceOpensearchComponents.class,
                "component", component,
                "host", host,
                "port", port,
                "route", route,
    ...
    public final static class Builder {
        ...
        public DbaasServiceOpensearchComponents build() {
