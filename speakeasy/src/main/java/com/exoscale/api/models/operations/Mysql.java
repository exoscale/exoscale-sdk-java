...
public class Mysql {
    ...
    private Optional<? extends GetDbaasSettingsMysqlProperties> properties;
    ...
    public Mysql(
            @JsonProperty("properties") Optional<? extends GetDbaasSettingsMysqlProperties> properties,
    ...
    public Optional<? extends GetDbaasSettingsMysqlProperties> properties() {
        return properties;
    }
    ...
    public Mysql withProperties(GetDbaasSettingsMysqlProperties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public Mysql withProperties(Optional<? extends GetDbaasSettingsMysqlProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public Mysql withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public Mysql withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public Mysql withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Mysql withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Mysql withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public Mysql withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetDbaasSettingsMysqlProperties> properties = Optional.empty();
        ...
        public Builder properties(GetDbaasSettingsMysqlProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = Optional.ofNullable(properties);
            return this;
        }

        public Builder properties(Optional<? extends GetDbaasSettingsMysqlProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
