...
/**
 * This is a model class for Instance type.
 */
public class Instance {
    ...
    /**
     * Converts this Instance into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Instance [" + "antiAffinityGroups=" + antiAffinityGroups + ", publicIpAssignment="
                + publicIpAssignment + ", labels=" + labels + ", securityGroups=" + securityGroups
                + ", elasticIps=" + elasticIps + ", name=" + name + ", instanceType=" + instanceType
                + ", privateNetworks=" + privateNetworks + ", template=" + template + ", state="
                + state + ", sshKey=" + sshKey + ", userData=" + userData + ", manager=" + manager
                + ", deployTarget=" + deployTarget + ", ipv6Address=" + ipv6Address + ", id=" + id
                + ", snapshots=" + snapshots + ", diskSize=" + diskSize + ", sshKeys=" + sshKeys
                + ", createdAt=" + createdAt + ", publicIp=" + publicIp + "]";
    }

    /**
     * Builds a new {@link Instance.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Instance.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Instance}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Instance} object using the set fields.
         * @return {@link Instance}
         */
        public Instance build() {
            return new Instance(antiAffinityGroups, publicIpAssignment, labels, securityGroups,
                    elasticIps, name, instanceType, privateNetworks, template, state, sshKey,
                    userData, manager, deployTarget, ipv6Address, id, snapshots, diskSize, sshKeys,
                    createdAt, publicIp);
        }
    }
}
