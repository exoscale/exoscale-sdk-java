...
public class DbaasKafkaPostRequestBodyAuthenticationMethods implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasKafkaPostRequestBodyAuthenticationMethods and sets the default values.
     */
    public DbaasKafkaPostRequestBodyAuthenticationMethods() {
    ...
    public static DbaasKafkaPostRequestBodyAuthenticationMethods createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasKafkaPostRequestBodyAuthenticationMethods();
    }
    /**
