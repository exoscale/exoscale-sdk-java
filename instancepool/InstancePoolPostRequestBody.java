...
public class InstancePoolPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new InstancePoolPostRequestBody and sets the default values.
     */
    public InstancePoolPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a InstancePoolPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static InstancePoolPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new InstancePoolPostRequestBody();
    }
    /**
