...
@JsonPropertyOrder({
  ...
  DbaasServiceRedis.JSON_PROPERTY_PROMETHEUS_URI,
...
public class DbaasServiceRedis {
  ...
  **/
  ...
  public DbaasServiceRedis prometheusUri(DbaasServiceMysqlPrometheusUri prometheusUri) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.updatedAt, dbaasServiceRedis.updatedAt) &&
        ...
        Objects.equals(this.prometheusUri, dbaasServiceRedis.prometheusUri) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(updatedAt, nodeCount, connectionInfo, nodeCpuCount, prometheusUri, integrations, zone, nodeStates, name, redisSettings, type, state, ipFilter, backups, terminationProtection, notifications, components, maintenance, diskSize, nodeMemory, uri, uriParams, version, createdAt, plan, users);
  }
