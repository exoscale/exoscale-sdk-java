...
public class StartInstanceResponse implements com.exoscale.api.utils.Response {
     ...
     * HTTP response status code for this operation
     */
    public StartInstanceResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public StartInstanceResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * 200
     */
    public StartInstanceResponse withOperation(com.exoscale.api.models.components.Operation operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * 200
     */
    public StartInstanceResponse withOperation(Optional<? extends com.exoscale.api.models.components.Operation> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StartInstanceResponse other = (StartInstanceResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StartInstanceResponse.class,
