...
public class WithNamePostRequestBodyMigration implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new WithNamePostRequestBodyMigration and sets the default values.
     */
    public WithNamePostRequestBodyMigration() {
    ...
    public static WithNamePostRequestBodyMigration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WithNamePostRequestBodyMigration();
    }
    /**
