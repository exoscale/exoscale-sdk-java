...
public class SksNodepoolIdEvictPutRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new SksNodepoolIdEvictPutRequestBody and sets the default values.
     */
    public SksNodepoolIdEvictPutRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a SksNodepoolIdEvictPutRequestBody
     */
    @jakarta.annotation.Nonnull
    public static SksNodepoolIdEvictPutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SksNodepoolIdEvictPutRequestBody();
    }
    /**
