...
public class DbaasPostgresPostRequestBodyMigration implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasPostgresPostRequestBodyMigration and sets the default values.
     */
    public DbaasPostgresPostRequestBodyMigration() {
    ...
    public static DbaasPostgresPostRequestBodyMigration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasPostgresPostRequestBodyMigration();
    }
    /**
