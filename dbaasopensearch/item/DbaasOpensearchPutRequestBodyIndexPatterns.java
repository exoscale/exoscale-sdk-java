...
public class DbaasOpensearchPutRequestBodyIndexPatterns implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DbaasOpensearchPutRequestBodyIndexPatternsSortingAlgorithm sortingAlgorithm;
    /**
     * Instantiates a new DbaasOpensearchPutRequestBodyIndexPatterns and sets the default values.
     */
    public DbaasOpensearchPutRequestBodyIndexPatterns() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasOpensearchPutRequestBodyIndexPatterns
     */
    @jakarta.annotation.Nonnull
    public static DbaasOpensearchPutRequestBodyIndexPatterns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasOpensearchPutRequestBodyIndexPatterns();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sorting-algorithm", (n) -> { this.setSortingAlgorithm(n.getEnumValue(DbaasOpensearchPutRequestBodyIndexPatternsSortingAlgorithm::forValue)); });
     ...
     * @return a DbaasOpensearchPutRequestBodyIndexPatternsSortingAlgorithm
     */
    @jakarta.annotation.Nullable
    public DbaasOpensearchPutRequestBodyIndexPatternsSortingAlgorithm getSortingAlgorithm() {
     ...
     */
    public void setSortingAlgorithm(@jakarta.annotation.Nullable final DbaasOpensearchPutRequestBodyIndexPatternsSortingAlgorithm value) {
