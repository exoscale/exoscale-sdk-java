...
/**
 * ListDbaasIntegrationSettingsSettings - The JSON schema representing the settings for the given integration type, source, and destination service types.
 */

public class ListDbaasIntegrationSettingsSettings {
    ...
    public ListDbaasIntegrationSettingsSettings(
    ...
    public ListDbaasIntegrationSettingsSettings withProperties(Properties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withProperties(Optional<? extends Properties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public ListDbaasIntegrationSettingsSettings withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListDbaasIntegrationSettingsSettings other = (ListDbaasIntegrationSettingsSettings) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListDbaasIntegrationSettingsSettings.class,
    ...
    public final static class Builder {
        ...
        public ListDbaasIntegrationSettingsSettings build() {
            return new ListDbaasIntegrationSettingsSettings(
                properties,
                additionalProperties,
                type,
                title);
