...
public class DbaasMysqlPostRequestBodyMigration implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasMysqlPostRequestBodyMigration and sets the default values.
     */
    public DbaasMysqlPostRequestBodyMigration() {
    ...
    public static DbaasMysqlPostRequestBodyMigration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasMysqlPostRequestBodyMigration();
    }
    /**
