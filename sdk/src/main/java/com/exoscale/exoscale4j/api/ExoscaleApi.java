...
import com.exoscale.exoscale4j.model.CreateAccessKeyRequest;
...
import com.exoscale.exoscale4j.model.ListAccessKeyKnownOperations200Response;
import com.exoscale.exoscale4j.model.ListAccessKeys200Response;
...
public class ExoscaleApi {
  ...
  private HttpRequest.Builder createAccessKeyRequestBuilder(CreateAccessKeyRequest createAccessKeyRequest) throws ApiException {
    ...
    String localVarPath = "/access-key";
      ...
      String authorizationValue;
          try{
          requestBody = memberVarObjectMapper.writeValueAsString(createAccessKeyRequest);
          } catch (JsonProcessingException e) {
          throw new ApiException(500, "Failed to serialize request body: " + e.getMessage());
          }
  ...
  private HttpRequest.Builder updateBlockStorageSnapshotRequestBuilder(UUID id, UpdateBlockStorageSnapshotRequest updateBlockStorageSnapshotRequest) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(updateBlockStorageSnapshotRequest);
      localVarRequestBuilder.method("PUT", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
  ...
  private HttpRequest.Builder updateBlockStorageVolumeRequestBuilder(UUID id, UpdateBlockStorageVolumeRequest updateBlockStorageVolumeRequest) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(updateBlockStorageVolumeRequest);
      localVarRequestBuilder.method("PUT", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
