...
import com.exoscale.exoscale4j.model.GetConsoleProxyUrl200Response;
...
public class ExoscaleApi {
   ...
   * 
   * @param id  (required)
   * @return GetConsoleProxyUrl200Response
   * @throws ApiException if fails to make API call
   */
  public GetConsoleProxyUrl200Response getConsoleProxyUrl(UUID id) throws ApiException {
    ApiResponse<GetConsoleProxyUrl200Response> localVarResponse = getConsoleProxyUrlWithHttpInfo(id);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<GetConsoleProxyUrl200Response> getConsoleProxyUrlWithHttpInfo(UUID id) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getConsoleProxyUrl", localVarResponse);
        }
        return new ApiResponse<GetConsoleProxyUrl200Response>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<GetConsoleProxyUrl200Response>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getConsoleProxyUrlRequestBuilder(UUID id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getConsoleProxyUrl");
    }

    Credentials credentials = apiClient.getCredentials();
    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/console/{id}"
        .replace("{id}", ApiClient.urlEncode(id.toString()));
      String requestBody = null;
      String authorizationValue;
