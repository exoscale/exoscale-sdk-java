...
public class CreateSecurityGroupResponse implements com.exoscale.api.utils.Response {
     ...
     * HTTP response content type for this operation
     */
    public CreateSecurityGroupResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateSecurityGroupResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateSecurityGroupResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * 200
     */
    public CreateSecurityGroupResponse withOperation(com.exoscale.api.models.components.Operation operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * 200
     */
    public CreateSecurityGroupResponse withOperation(Optional<? extends com.exoscale.api.models.components.Operation> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSecurityGroupResponse other = (CreateSecurityGroupResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateSecurityGroupResponse.class,
