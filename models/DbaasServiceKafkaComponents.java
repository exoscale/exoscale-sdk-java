...
public class DbaasServiceKafkaComponents implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String host;
    /**
     * The kafkaAuthenticationMethod property
     */
    ...
    /**
     * Instantiates a new DbaasServiceKafkaComponents and sets the default values.
     */
     ...
     * @return a DbaasServiceKafkaComponents
     */
    @jakarta.annotation.Nonnull
    public static DbaasServiceKafkaComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kafka-authentication-method", (n) -> { this.setKafkaAuthenticationMethod(n.getEnumValue(EnumKafkaAuthMethod::forValue)); });
    ...
    /**
     * Gets the kafka-authentication-method property value. The kafkaAuthenticationMethod property
     * @return a EnumKafkaAuthMethod
     */
    @jakarta.annotation.Nullable
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeEnumValue("kafka-authentication-method", this.getKafkaAuthenticationMethod());
    ...
    /**
     * Sets the kafka-authentication-method property value. The kafkaAuthenticationMethod property
     * @param value Value to set for the kafka-authentication-method property.
     */
    public void setKafkaAuthenticationMethod(@jakarta.annotation.Nullable final EnumKafkaAuthMethod value) {
