...
public class CreateDbaasServicePgBackupSchedule {
    ...
    public CreateDbaasServicePgBackupSchedule(
     ...
     * The hour of day (in UTC) when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServicePgBackupSchedule withBackupHour(long backupHour) {
        Utils.checkNotNull(backupHour, "backupHour");
     ...
     * The hour of day (in UTC) when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServicePgBackupSchedule withBackupHour(Optional<? extends Long> backupHour) {
        Utils.checkNotNull(backupHour, "backupHour");
        this.backupHour = backupHour;
        return this;
    }
     ...
     * The minute of an hour when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServicePgBackupSchedule withBackupMinute(long backupMinute) {
        Utils.checkNotNull(backupMinute, "backupMinute");
     ...
     * The minute of an hour when backup for the service is started. New backup is only started if previous backup has already completed.
     */
    public CreateDbaasServicePgBackupSchedule withBackupMinute(Optional<? extends Long> backupMinute) {
        Utils.checkNotNull(backupMinute, "backupMinute");
        this.backupMinute = backupMinute;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateDbaasServicePgBackupSchedule other = (CreateDbaasServicePgBackupSchedule) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateDbaasServicePgBackupSchedule.class,
    ...
    public final static class Builder {
        ...
        public CreateDbaasServicePgBackupSchedule build() {
            return new CreateDbaasServicePgBackupSchedule(
                backupHour,
                backupMinute);
        }
    }
