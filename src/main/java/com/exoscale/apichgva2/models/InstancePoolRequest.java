...
/**
 * This is a model class for InstancePoolRequest type.
 */
public class InstancePoolRequest {
    ...
    /**
     * Converts this InstancePoolRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InstancePoolRequest [" + "name=" + name + ", instanceType=" + instanceType
                + ", template=" + template + ", size=" + size + ", diskSize=" + diskSize
                + ", antiAffinityGroups=" + antiAffinityGroups + ", description=" + description
                + ", publicIpAssignment=" + publicIpAssignment + ", labels=" + labels
                + ", securityGroups=" + securityGroups + ", elasticIps=" + elasticIps
                + ", minAvailable=" + minAvailable + ", privateNetworks=" + privateNetworks
                + ", sshKey=" + sshKey + ", instancePrefix=" + instancePrefix + ", userData="
                + userData + ", deployTarget=" + deployTarget + ", ipv6Enabled=" + ipv6Enabled
                + ", sshKeys=" + sshKeys + "]";
    }

    /**
     * Builds a new {@link InstancePoolRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InstancePoolRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(name, instanceType, template, size, diskSize)
    ...
    /**
     * Class to build instances of {@link InstancePoolRequest}.
     */
    public static class Builder {
         ...
         * @param  diskSize  long value for diskSize.
         */
        public Builder(String name, InstanceType instanceType, Template template, long size,
                long diskSize) {
            this.name = name;
            this.instanceType = instanceType;
            this.template = template;
        ...
        /**
         * Builds a new {@link InstancePoolRequest} object using the set fields.
         * @return {@link InstancePoolRequest}
         */
        public InstancePoolRequest build() {
            return new InstancePoolRequest(name, instanceType, template, size, diskSize,
                    antiAffinityGroups, description, publicIpAssignment, labels, securityGroups,
                    elasticIps, minAvailable, privateNetworks, sshKey, instancePrefix, userData,
