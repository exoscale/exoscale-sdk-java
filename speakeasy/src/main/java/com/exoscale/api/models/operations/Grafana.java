...
public class Grafana {
    ...
    private Optional<? extends GetDbaasSettingsGrafanaProperties> properties;
    ...
    public Grafana(
            @JsonProperty("properties") Optional<? extends GetDbaasSettingsGrafanaProperties> properties,
    ...
    public Optional<? extends GetDbaasSettingsGrafanaProperties> properties() {
        return properties;
    }
    ...
    public Grafana withProperties(GetDbaasSettingsGrafanaProperties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public Grafana withProperties(Optional<? extends GetDbaasSettingsGrafanaProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public Grafana withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public Grafana withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public Grafana withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Grafana withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Grafana withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public Grafana withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Grafana.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetDbaasSettingsGrafanaProperties> properties = Optional.empty();
        ...
        public Builder properties(GetDbaasSettingsGrafanaProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = Optional.ofNullable(properties);
            return this;
        }

        public Builder properties(Optional<? extends GetDbaasSettingsGrafanaProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
