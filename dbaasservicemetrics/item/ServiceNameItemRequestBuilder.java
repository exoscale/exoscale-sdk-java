...
/**
 * Builds and executes requests for operations under /dbaas-service-metrics/{service-name}
 */
...
public class ServiceNameItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceNameItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-service-metrics/{service%2Dname}", pathParameters);
    }
    /**
     * Instantiates a new ServiceNameItemRequestBuilder and sets the default values.
    ...
    public ServiceNameItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-service-metrics/{service%2Dname}", rawUrl);
    }
    /**
    ...
    public ServiceNamePostResponse post(@jakarta.annotation.Nonnull final ServiceNamePostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceNamePostResponse post(@jakarta.annotation.Nonnull final ServiceNamePostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceNamePostResponse::createFromDiscriminatorValue);
    }
    /**
     * Get metrics of DBaaS service
     * @param body The request body
