...
/**
 * This is a model class for Pg type.
 */
public class Pg {
    ...
    /**
     * Converts this Pg into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Pg [" + "properties=" + properties + ", additionalProperties="
                + additionalProperties + ", type=" + type + ", title=" + title + "]";
    }

    /**
     * Builds a new {@link Pg.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Pg.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Pg}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Pg} object using the set fields.
         * @return {@link Pg}
         */
        public Pg build() {
            return new Pg(properties, additionalProperties, type, title);
        }
    }
}
