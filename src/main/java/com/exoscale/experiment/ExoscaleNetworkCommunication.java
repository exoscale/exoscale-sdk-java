...
public class ExoscaleNetworkCommunication {
    ...
    public InstanceResponse createNewAntiAffinityGroup(String requestBody) {
        ...
        try {
            ...
            logger.error("Error creating new Anti Affinity Group " + ANTI_AFFINITY_GROUP + ": ", e);
            throw new ExoscaleNetworkCommunicationException("Error creating new Anti Affinity Group " + ANTI_AFFINITY_GROUP);
        }
    }
}
