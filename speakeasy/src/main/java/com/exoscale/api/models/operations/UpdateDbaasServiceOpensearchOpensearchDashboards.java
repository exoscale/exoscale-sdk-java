...
/**
 * UpdateDbaasServiceOpensearchOpensearchDashboards - OpenSearch Dashboards settings
 */

public class UpdateDbaasServiceOpensearchOpensearchDashboards {
    ...
    public UpdateDbaasServiceOpensearchOpensearchDashboards(
     ...
     * Timeout in milliseconds for requests made by OpenSearch Dashboards towards OpenSearch (default: 30000)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withOpensearchRequestTimeout(long opensearchRequestTimeout) {
        Utils.checkNotNull(opensearchRequestTimeout, "opensearchRequestTimeout");
     ...
     * Timeout in milliseconds for requests made by OpenSearch Dashboards towards OpenSearch (default: 30000)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withOpensearchRequestTimeout(Optional<? extends Long> opensearchRequestTimeout) {
        Utils.checkNotNull(opensearchRequestTimeout, "opensearchRequestTimeout");
        this.opensearchRequestTimeout = opensearchRequestTimeout;
        return this;
    }
     ...
     * Enable or disable OpenSearch Dashboards (default: true)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withEnabled(boolean enabled) {
        Utils.checkNotNull(enabled, "enabled");
     ...
     * Enable or disable OpenSearch Dashboards (default: true)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withEnabled(Optional<? extends Boolean> enabled) {
        Utils.checkNotNull(enabled, "enabled");
        this.enabled = enabled;
        return this;
    }
     ...
     * Limits the maximum amount of memory (in MiB) the OpenSearch Dashboards process can use. This sets the max_old_space_size option of the nodejs running the OpenSearch Dashboards. Note: the memory reserved by OpenSearch Dashboards is not available for OpenSearch. (default: 128)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withMaxOldSpaceSize(long maxOldSpaceSize) {
        Utils.checkNotNull(maxOldSpaceSize, "maxOldSpaceSize");
     ...
     * Limits the maximum amount of memory (in MiB) the OpenSearch Dashboards process can use. This sets the max_old_space_size option of the nodejs running the OpenSearch Dashboards. Note: the memory reserved by OpenSearch Dashboards is not available for OpenSearch. (default: 128)
     */
    public UpdateDbaasServiceOpensearchOpensearchDashboards withMaxOldSpaceSize(Optional<? extends Long> maxOldSpaceSize) {
        Utils.checkNotNull(maxOldSpaceSize, "maxOldSpaceSize");
        this.maxOldSpaceSize = maxOldSpaceSize;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDbaasServiceOpensearchOpensearchDashboards other = (UpdateDbaasServiceOpensearchOpensearchDashboards) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateDbaasServiceOpensearchOpensearchDashboards.class,
    ...
    public final static class Builder {
        ...
        public UpdateDbaasServiceOpensearchOpensearchDashboards build() {
            return new UpdateDbaasServiceOpensearchOpensearchDashboards(
                opensearchRequestTimeout,
                enabled,
                maxOldSpaceSize);
        }
