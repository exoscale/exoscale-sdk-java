...
public class DbaasPostgresPostRequestBodyBackupSchedule implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasPostgresPostRequestBodyBackupSchedule and sets the default values.
     */
    public DbaasPostgresPostRequestBodyBackupSchedule() {
    ...
    public static DbaasPostgresPostRequestBodyBackupSchedule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasPostgresPostRequestBodyBackupSchedule();
    }
    /**
