...
public class DbaasServiceOpensearchOpensearchDashboards implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasServiceOpensearchOpensearchDashboards and sets the default values.
     */
    public DbaasServiceOpensearchOpensearchDashboards() {
    ...
    public static DbaasServiceOpensearchOpensearchDashboards createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasServiceOpensearchOpensearchDashboards();
    }
    /**
