...
public class Redis {
    ...
    private Optional<? extends GetDbaasSettingsRedisProperties> properties;
    ...
    public Redis(
            @JsonProperty("properties") Optional<? extends GetDbaasSettingsRedisProperties> properties,
    ...
    public Optional<? extends GetDbaasSettingsRedisProperties> properties() {
        return properties;
    }
    ...
    public Redis withProperties(GetDbaasSettingsRedisProperties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public Redis withProperties(Optional<? extends GetDbaasSettingsRedisProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public Redis withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public Redis withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public Redis withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Redis withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Redis withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public Redis withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Redis.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetDbaasSettingsRedisProperties> properties = Optional.empty();
        ...
        public Builder properties(GetDbaasSettingsRedisProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = Optional.ofNullable(properties);
            return this;
        }

        public Builder properties(Optional<? extends GetDbaasSettingsRedisProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
