...
public class JsonSchemaGrafanaAuthAzuread implements Parsable {
    /**
     * The allowed_domains property
     */
    private java.util.List<String> allowedDomains;
    /**
     * The allowed_groups property
     */
    ...
    public static JsonSchemaGrafanaAuthAzuread createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new JsonSchemaGrafanaAuthAzuread();
    }
    /**
    ...
    /**
     * Gets the allowed_groups property value. The allowed_groups property
     * @return a java.util.List<String>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("allowed_groups", (n) -> { this.setAllowedGroups(n.getCollectionOfPrimitiveValues(String.class)); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfPrimitiveValues("allowed_groups", this.getAllowedGroups());
    ...
    /**
     * Sets the allowed_groups property value. The allowed_groups property
