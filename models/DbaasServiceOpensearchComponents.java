...
public class DbaasServiceOpensearchComponents implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasServiceOpensearchComponents and sets the default values.
     */
    public DbaasServiceOpensearchComponents() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasServiceOpensearchComponents
     */
    @jakarta.annotation.Nonnull
    public static DbaasServiceOpensearchComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasServiceOpensearchComponents();
    }
    /**
