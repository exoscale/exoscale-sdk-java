 ...
 */
@JsonPropertyOrder({
  Title7.JSON_PROPERTY_UPDATED_AT,
  Title7.JSON_PROPERTY_NAME,
  Title7.JSON_PROPERTY_STATUS,
  Title7.JSON_PROPERTY_ID,
  Title7.JSON_PROPERTY_MODEL_SIZE,
  Title7.JSON_PROPERTY_CREATED_AT
})
...
public class Title7 {
  ...
  **/
  ...
  public Title7 name(Object name) {
  ...
  **/
  ...
  public Title7 status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public Title7 modelSize(Object modelSize) {
  ...
  **/
  ...
  /**
   * Return true if this title_7 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Title7 title7 = (Title7) o;
    return equalsNullable(this.updatedAt, title7.updatedAt) &&
        equalsNullable(this.name, title7.name) &&
        Objects.equals(this.status, title7.status) &&
        equalsNullable(this.id, title7.id) &&
        equalsNullable(this.modelSize, title7.modelSize) &&
        equalsNullable(this.createdAt, title7.createdAt);
  }
