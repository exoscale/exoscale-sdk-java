package com.exoscale.iamrole.withidpolicy;
...
public class WithIdPolicyRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new WithIdPolicyRequestBuilder and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WithIdPolicyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter, @jakarta.annotation.Nullable final UUID id) {
        super(requestAdapter, "{+baseurl}/iam-role/{id}:policy", pathParameters);
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WithIdPolicyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/iam-role/{id}:policy", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public WithIdPolicyRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new WithIdPolicyRequestBuilder(rawUrl, requestAdapter);
    }
    /**
