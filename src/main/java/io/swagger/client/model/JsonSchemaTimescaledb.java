...
public class JsonSchemaTimescaledb {
  ...
  private Integer maxBackgroundWorkers = null;
  ...
  **/
  @Schema(example = "8", description = "The number of background workers for timescaledb operations. You should configure this setting to the sum of your number of databases and the total number of concurrent background workers you want running at any given point in time.")
