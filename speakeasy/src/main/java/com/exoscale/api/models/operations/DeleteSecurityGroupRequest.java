...
public class DeleteSecurityGroupRequest {
    ...
    public DeleteSecurityGroupRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteSecurityGroupRequest other = (DeleteSecurityGroupRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteSecurityGroupRequest.class,
                "id", id);
    }
