...
/**
 * This is a model class for DbaasKafkaRequest1 type.
 */
public class DbaasKafkaRequest1 {
    ...
    /**
     * Converts this DbaasKafkaRequest1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DbaasKafkaRequest1 [" + "authenticationMethods=" + authenticationMethods
                + ", kafkaRestEnabled=" + kafkaRestEnabled + ", kafkaConnectEnabled="
                + kafkaConnectEnabled + ", ipFilter=" + ipFilter + ", schemaRegistrySettings="
                + schemaRegistrySettings + ", kafkaRestSettings=" + kafkaRestSettings
                + ", terminationProtection=" + terminationProtection + ", kafkaConnectSettings="
                + kafkaConnectSettings + ", maintenance=" + maintenance + ", kafkaSettings="
                + kafkaSettings + ", schemaRegistryEnabled=" + schemaRegistryEnabled + ", version="
                + version + ", plan=" + plan + "]";
    }

    /**
     * Builds a new {@link DbaasKafkaRequest1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DbaasKafkaRequest1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DbaasKafkaRequest1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link DbaasKafkaRequest1} object using the set fields.
         * @return {@link DbaasKafkaRequest1}
         */
        public DbaasKafkaRequest1 build() {
            return new DbaasKafkaRequest1(authenticationMethods, kafkaRestEnabled,
                    ...
                    schemaRegistryEnabled, version, plan);
        }
    }
}
