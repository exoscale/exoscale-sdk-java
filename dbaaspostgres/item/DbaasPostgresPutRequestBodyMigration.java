...
public class DbaasPostgresPutRequestBodyMigration implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasPostgresPutRequestBodyMigration and sets the default values.
     */
    public DbaasPostgresPutRequestBodyMigration() {
    ...
    public static DbaasPostgresPutRequestBodyMigration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasPostgresPutRequestBodyMigration();
    }
    /**
