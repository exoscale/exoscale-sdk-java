 ...
 */
@JsonPropertyOrder({
  Title3Model.JSON_PROPERTY_NAME,
  Title3Model.JSON_PROPERTY_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.4.0")
public class Title3Model {
  ...
  public Title3Model name(Object name) {
  ...
  **/
  ...
  public Title3Model id(Object id) {
  ...
  **/
  ...
  /**
   * Return true if this title_3_model object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Title3Model title3Model = (Title3Model) o;
    return equalsNullable(this.name, title3Model.name) &&
        equalsNullable(this.id, title3Model.id);
  }
