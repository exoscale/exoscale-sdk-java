...
import io.swagger.client.model.PrivateNetworkLease;
...
public class PrivateNetwork {
  ...
  @JsonProperty("leases")
  private List<PrivateNetworkLease> leases = null;
   ...
   * @return id
  **/
  @Schema(description = "Private Network ID")
  public UUID getId() {
    return id;
  }
  ...
  **/
   ...
   * @return leases
  **/
  @Schema(description = "Private Network leased IP addresses")
  public List<PrivateNetworkLease> getLeases() {
    return leases;
  }

  public PrivateNetwork labels(Labels labels) {
    this.labels = labels;
    return this;
  }
