 ...
 */
@JsonPropertyOrder({
  ListAiApiKeysResponseEntry.JSON_PROPERTY_UPDATED_AT,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_NAME,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_DEPLOYMENTS,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_MODELS,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_ID,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_REVOKED_AT,
  ListAiApiKeysResponseEntry.JSON_PROPERTY_CREATED_AT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.4.0")
public class ListAiApiKeysResponseEntry {
  ...
  public ListAiApiKeysResponseEntry() { 
  }
  ...
  **/
  ...
  public ListAiApiKeysResponseEntry name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ListAiApiKeysResponseEntry deployments(List<AiApiKeyDeploymentsResponseInner> deployments) {
    this.deployments = deployments;
    return this;
  }

  public ListAiApiKeysResponseEntry addDeploymentsItem(AiApiKeyDeploymentsResponseInner deploymentsItem) {
  ...
  **/
  ...
  public ListAiApiKeysResponseEntry models(Set<String> models) {
    this.models = models;
    return this;
  }

  public ListAiApiKeysResponseEntry addModelsItem(String modelsItem) {
    if (this.models == null) {
  ...
  **/
  ...
  /**
   * Return true if this list-ai-api-keys-response-entry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListAiApiKeysResponseEntry listAiApiKeysResponseEntry = (ListAiApiKeysResponseEntry) o;
    return Objects.equals(this.updatedAt, listAiApiKeysResponseEntry.updatedAt) &&
        Objects.equals(this.name, listAiApiKeysResponseEntry.name) &&
        Objects.equals(this.deployments, listAiApiKeysResponseEntry.deployments) &&
        Objects.equals(this.models, listAiApiKeysResponseEntry.models) &&
        Objects.equals(this.id, listAiApiKeysResponseEntry.id) &&
        Objects.equals(this.revokedAt, listAiApiKeysResponseEntry.revokedAt) &&
        Objects.equals(this.createdAt, listAiApiKeysResponseEntry.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updatedAt, name, deployments, models, id, revokedAt, createdAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAiApiKeysResponseEntry {\n");
