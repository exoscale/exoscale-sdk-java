package com.exoscale.dbaaskafka.item.user.item;

import com.exoscale.dbaaskafka.item.user.item.password.PasswordRequestBuilder;
...
/**
 * Builds and executes requests for operations under /dbaas-kafka/{service-name}/user/{username}
 */
...
public class WithUsernameItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithUsernameItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-kafka/{service%2Dname}/user/{username}", pathParameters);
    }
    /**
     * Instantiates a new WithUsernameItemRequestBuilder and sets the default values.
    ...
    public WithUsernameItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-kafka/{service%2Dname}/user/{username}", rawUrl);
    }
    /**
     * null
     * @return a Operation
