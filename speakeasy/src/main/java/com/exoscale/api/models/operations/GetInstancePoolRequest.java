...
public class GetInstancePoolRequest {
    ...
    public GetInstancePoolRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetInstancePoolRequest.class,
                "id", id);
    }
    ...
    public final static class Builder {
        ...
        public GetInstancePoolRequest build() {
            return new GetInstancePoolRequest(
                id);
        }
    }
}
