...
|**transactionPartitionVerificationEnable** | **Boolean** | Enable verification that checks that the partition has been added to the transaction before writing transactional records to the partition |  [optional] |
