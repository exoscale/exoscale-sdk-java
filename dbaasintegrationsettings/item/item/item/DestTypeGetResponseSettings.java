...
public class DestTypeGetResponseSettings implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DestTypeGetResponseSettingsProperties properties;
    /**
     * The title property
     */
    ...
    private String type;
    /**
     * Instantiates a new DestTypeGetResponseSettings and sets the default values.
     */
    public DestTypeGetResponseSettings() {
    ...
    public static DestTypeGetResponseSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DestTypeGetResponseSettings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("properties", (n) -> { this.setProperties(n.getObjectValue(DestTypeGetResponseSettingsProperties::createFromDiscriminatorValue)); });
     ...
     * @return a DestTypeGetResponseSettingsProperties
     */
    @jakarta.annotation.Nullable
    public DestTypeGetResponseSettingsProperties getProperties() {
     ...
     */
    public void setProperties(@jakarta.annotation.Nullable final DestTypeGetResponseSettingsProperties value) {
