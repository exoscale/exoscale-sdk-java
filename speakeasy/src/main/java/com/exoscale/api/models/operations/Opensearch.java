...
public class Opensearch {
    ...
    private Optional<? extends GetDbaasSettingsOpensearchProperties> properties;
    ...
    public Opensearch(
            @JsonProperty("properties") Optional<? extends GetDbaasSettingsOpensearchProperties> properties,
    ...
    public Optional<? extends GetDbaasSettingsOpensearchProperties> properties() {
        return properties;
    }
    ...
    public Opensearch withProperties(GetDbaasSettingsOpensearchProperties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public Opensearch withProperties(Optional<? extends GetDbaasSettingsOpensearchProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public Opensearch withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public Opensearch withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public Opensearch withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Opensearch withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Opensearch withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public Opensearch withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Opensearch.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetDbaasSettingsOpensearchProperties> properties = Optional.empty();
        ...
        public Builder properties(GetDbaasSettingsOpensearchProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = Optional.ofNullable(properties);
            return this;
        }

        public Builder properties(Optional<? extends GetDbaasSettingsOpensearchProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
