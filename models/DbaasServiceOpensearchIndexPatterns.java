...
public class DbaasServiceOpensearchIndexPatterns implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DbaasServiceOpensearchIndexPatternsSortingAlgorithm sortingAlgorithm;
    /**
     * Instantiates a new DbaasServiceOpensearchIndexPatterns and sets the default values.
     */
    public DbaasServiceOpensearchIndexPatterns() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasServiceOpensearchIndexPatterns
     */
    @jakarta.annotation.Nonnull
    public static DbaasServiceOpensearchIndexPatterns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasServiceOpensearchIndexPatterns();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sorting-algorithm", (n) -> { this.setSortingAlgorithm(n.getEnumValue(DbaasServiceOpensearchIndexPatternsSortingAlgorithm::forValue)); });
     ...
     * @return a DbaasServiceOpensearchIndexPatternsSortingAlgorithm
     */
    @jakarta.annotation.Nullable
    public DbaasServiceOpensearchIndexPatternsSortingAlgorithm getSortingAlgorithm() {
     ...
     */
    public void setSortingAlgorithm(@jakarta.annotation.Nullable final DbaasServiceOpensearchIndexPatternsSortingAlgorithm value) {
