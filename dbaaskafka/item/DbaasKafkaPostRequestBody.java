...
public class DbaasKafkaPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DbaasKafkaPostRequestBodyAuthenticationMethods authenticationMethods;
    /**
     ...
     */
    private DbaasKafkaPostRequestBodyMaintenance maintenance;
    /**
     * Subscription plan
     */
    private String plan;
    ...
    /**
     * Instantiates a new DbaasKafkaPostRequestBody and sets the default values.
     */
    public DbaasKafkaPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasKafkaPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static DbaasKafkaPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasKafkaPostRequestBody();
    }
    /**
     ...
     * @return a DbaasKafkaPostRequestBodyAuthenticationMethods
     */
    @jakarta.annotation.Nullable
    public DbaasKafkaPostRequestBodyAuthenticationMethods getAuthenticationMethods() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication-methods", (n) -> { this.setAuthenticationMethods(n.getObjectValue(DbaasKafkaPostRequestBodyAuthenticationMethods::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("maintenance", (n) -> { this.setMaintenance(n.getObjectValue(DbaasKafkaPostRequestBodyMaintenance::createFromDiscriminatorValue)); });
     ...
     * @return a DbaasKafkaPostRequestBodyMaintenance
     */
    @jakarta.annotation.Nullable
    public DbaasKafkaPostRequestBodyMaintenance getMaintenance() {
     ...
     */
    public void setAuthenticationMethods(@jakarta.annotation.Nullable final DbaasKafkaPostRequestBodyAuthenticationMethods value) {
     ...
     */
    public void setMaintenance(@jakarta.annotation.Nullable final DbaasKafkaPostRequestBodyMaintenance value) {
