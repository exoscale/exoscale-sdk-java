...
public class InternalAuthenticationBackendLimiting {
  ...
  public enum AuthenticationBackendEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AuthenticationBackendEnum.fromValue(value);
    }
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `authentication_backend`
      if (jsonObj.get("authentication_backend") != null && !jsonObj.get("authentication_backend").isJsonNull()) {
        AuthenticationBackendEnum.validateJsonElement(jsonObj.get("authentication_backend"));
      }
  }
