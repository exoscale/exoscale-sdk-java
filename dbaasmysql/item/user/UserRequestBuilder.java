...
import com.exoscale.dbaasmysql.item.user.item.WithUsernameItemRequestBuilder;
...
/**
 * Builds and executes requests for operations under /dbaas-mysql/{dbaasMysql-id}/user
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class UserRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the com.exoscale.dbaasMysql.item.user.item collection
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-mysql/{dbaasMysql%2Did}/user", pathParameters);
    }
    /**
     * Instantiates a new UserRequestBuilder and sets the default values.
    ...
    public UserRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/dbaas-mysql/{dbaasMysql%2Did}/user", rawUrl);
    }
    /**
     * null
