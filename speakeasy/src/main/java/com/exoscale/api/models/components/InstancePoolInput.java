...
/**
 * InstancePoolInput - Instance Pool
 */

public class InstancePoolInput {
     ...
     * Instance Pool Anti-affinity Groups
     */
    public InstancePoolInput withAntiAffinityGroups(java.util.List<AntiAffinityGroupInput> antiAffinityGroups) {
        Utils.checkNotNull(antiAffinityGroups, "antiAffinityGroups");
     ...
     * Instance Pool Anti-affinity Groups
     */
    public InstancePoolInput withAntiAffinityGroups(Optional<? extends java.util.List<AntiAffinityGroupInput>> antiAffinityGroups) {
        Utils.checkNotNull(antiAffinityGroups, "antiAffinityGroups");
        this.antiAffinityGroups = antiAffinityGroups;
        return this;
    }
     ...
     * Instance Pool description
     */
    public InstancePoolInput withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * Instance Pool description
     */
    public InstancePoolInput withDescription(Optional<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public InstancePoolInput withPublicIpAssignment(PublicIpAssignment publicIpAssignment) {
        Utils.checkNotNull(publicIpAssignment, "publicIpAssignment");
        this.publicIpAssignment = Optional.ofNullable(publicIpAssignment);
        return this;
    }

    public InstancePoolInput withPublicIpAssignment(Optional<? extends PublicIpAssignment> publicIpAssignment) {
        Utils.checkNotNull(publicIpAssignment, "publicIpAssignment");
        this.publicIpAssignment = publicIpAssignment;
        return this;
    }

    public InstancePoolInput withLabels(java.util.Map<String, String> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = Optional.ofNullable(labels);
        return this;
    }

    public InstancePoolInput withLabels(Optional<? extends java.util.Map<String, String>> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = labels;
        return this;
    }
     ...
     * Instance Pool Security Groups
     */
    public InstancePoolInput withSecurityGroups(java.util.List<SecurityGroupInput> securityGroups) {
        Utils.checkNotNull(securityGroups, "securityGroups");
     ...
     * Instance Pool Security Groups
     */
    public InstancePoolInput withSecurityGroups(Optional<? extends java.util.List<SecurityGroupInput>> securityGroups) {
        Utils.checkNotNull(securityGroups, "securityGroups");
        this.securityGroups = securityGroups;
        return this;
    }
     ...
     * Instances Elastic IPs
     */
    public InstancePoolInput withElasticIps(java.util.List<ElasticIpInput> elasticIps) {
        Utils.checkNotNull(elasticIps, "elasticIps");
     ...
     * Instances Elastic IPs
     */
    public InstancePoolInput withElasticIps(Optional<? extends java.util.List<ElasticIpInput>> elasticIps) {
        Utils.checkNotNull(elasticIps, "elasticIps");
        this.elasticIps = elasticIps;
        return this;
    }
     ...
     * Instance Pool name
     */
    public InstancePoolInput withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Instance Pool name
     */
    public InstancePoolInput withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Compute instance type
     */
    public InstancePoolInput withInstanceType(InstanceTypeInput instanceType) {
        Utils.checkNotNull(instanceType, "instanceType");
     ...
     * Compute instance type
     */
    public InstancePoolInput withInstanceType(Optional<? extends InstanceTypeInput> instanceType) {
        Utils.checkNotNull(instanceType, "instanceType");
        this.instanceType = instanceType;
        return this;
    }
     ...
     * Minimum number of running instances
     */
    public InstancePoolInput withMinAvailable(long minAvailable) {
        Utils.checkNotNull(minAvailable, "minAvailable");
     ...
     * Minimum number of running instances
     */
    public InstancePoolInput withMinAvailable(Optional<? extends Long> minAvailable) {
        Utils.checkNotNull(minAvailable, "minAvailable");
        this.minAvailable = minAvailable;
        return this;
    }
     ...
     * Instance Pool Private Networks
     */
    public InstancePoolInput withPrivateNetworks(java.util.List<PrivateNetworkInput> privateNetworks) {
        Utils.checkNotNull(privateNetworks, "privateNetworks");
     ...
     * Instance Pool Private Networks
     */
    public InstancePoolInput withPrivateNetworks(Optional<? extends java.util.List<PrivateNetworkInput>> privateNetworks) {
        Utils.checkNotNull(privateNetworks, "privateNetworks");
        this.privateNetworks = privateNetworks;
        return this;
    }
     ...
     * Instance template
     */
    public InstancePoolInput withTemplate(TemplateInput template) {
        Utils.checkNotNull(template, "template");
     ...
     * Instance template
     */
    public InstancePoolInput withTemplate(Optional<? extends TemplateInput> template) {
        Utils.checkNotNull(template, "template");
        this.template = template;
        return this;
    }
     ...
     * Number of instances
     */
    public InstancePoolInput withSize(long size) {
        Utils.checkNotNull(size, "size");
     ...
     * Number of instances
     */
    public InstancePoolInput withSize(Optional<? extends Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * SSH key
     */
    public InstancePoolInput withSshKey(SshKeyInput sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
     ...
     * SSH key
     */
    public InstancePoolInput withSshKey(Optional<? extends SshKeyInput> sshKey) {
        Utils.checkNotNull(sshKey, "sshKey");
        this.sshKey = sshKey;
        return this;
    }
     ...
     * The instances created by the Instance Pool will be prefixed with this value (default: pool)
     */
    public InstancePoolInput withInstancePrefix(String instancePrefix) {
        Utils.checkNotNull(instancePrefix, "instancePrefix");
     ...
     * The instances created by the Instance Pool will be prefixed with this value (default: pool)
     */
    public InstancePoolInput withInstancePrefix(Optional<? extends String> instancePrefix) {
        Utils.checkNotNull(instancePrefix, "instancePrefix");
        this.instancePrefix = instancePrefix;
        return this;
    }
     ...
     * Instances Cloud-init user-data
     */
    public InstancePoolInput withUserData(String userData) {
        Utils.checkNotNull(userData, "userData");
     ...
     * Instances Cloud-init user-data
     */
    public InstancePoolInput withUserData(Optional<? extends String> userData) {
        Utils.checkNotNull(userData, "userData");
        this.userData = userData;
        return this;
    }
     ...
     * Resource manager
     */
    public InstancePoolInput withManager(Manager manager) {
        Utils.checkNotNull(manager, "manager");
     ...
     * Resource manager
     */
    public InstancePoolInput withManager(Optional<? extends Manager> manager) {
        Utils.checkNotNull(manager, "manager");
        this.manager = manager;
        return this;
    }
     ...
     * Deploy target
     */
    public InstancePoolInput withDeployTarget(DeployTarget deployTarget) {
        Utils.checkNotNull(deployTarget, "deployTarget");
     ...
     * Deploy target
     */
    public InstancePoolInput withDeployTarget(Optional<? extends DeployTarget> deployTarget) {
        Utils.checkNotNull(deployTarget, "deployTarget");
        this.deployTarget = deployTarget;
        return this;
    }
     ...
     * Enable IPv6 for instances
     */
    public InstancePoolInput withIpv6Enabled(boolean ipv6Enabled) {
        Utils.checkNotNull(ipv6Enabled, "ipv6Enabled");
     ...
     * Enable IPv6 for instances
     */
    public InstancePoolInput withIpv6Enabled(Optional<? extends Boolean> ipv6Enabled) {
        Utils.checkNotNull(ipv6Enabled, "ipv6Enabled");
        this.ipv6Enabled = ipv6Enabled;
        return this;
    }
     ...
     * Instances disk size in GB
     */
    public InstancePoolInput withDiskSize(long diskSize) {
        Utils.checkNotNull(diskSize, "diskSize");
     ...
     * Instances disk size in GB
     */
    public InstancePoolInput withDiskSize(Optional<? extends Long> diskSize) {
        Utils.checkNotNull(diskSize, "diskSize");
        this.diskSize = diskSize;
        return this;
    }
     ...
     * Instances SSH keys
     */
    public InstancePoolInput withSshKeys(java.util.List<SshKeyInput> sshKeys) {
        Utils.checkNotNull(sshKeys, "sshKeys");
     ...
     * Instances SSH keys
     */
    public InstancePoolInput withSshKeys(Optional<? extends java.util.List<SshKeyInput>> sshKeys) {
        Utils.checkNotNull(sshKeys, "sshKeys");
        this.sshKeys = sshKeys;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InstancePoolInput other = (InstancePoolInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InstancePoolInput.class,
    ...
    public final static class Builder {
        ...
        public InstancePoolInput build() {
            return new InstancePoolInput(
                antiAffinityGroups,
                description,
                publicIpAssignment,
                labels,
