...
public class CopyTemplateResponse implements com.exoscale.api.utils.Response {
     ...
     * HTTP response status code for this operation
     */
    public CopyTemplateResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CopyTemplateResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * 200
     */
    public CopyTemplateResponse withOperation(com.exoscale.api.models.components.Operation operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * 200
     */
    public CopyTemplateResponse withOperation(Optional<? extends com.exoscale.api.models.components.Operation> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CopyTemplateResponse other = (CopyTemplateResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CopyTemplateResponse.class,
