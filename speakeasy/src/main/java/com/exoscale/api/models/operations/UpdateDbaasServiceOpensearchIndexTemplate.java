...
/**
 * UpdateDbaasServiceOpensearchIndexTemplate - Template settings for all new indexes
 */

public class UpdateDbaasServiceOpensearchIndexTemplate {
    ...
    public UpdateDbaasServiceOpensearchIndexTemplate(
     ...
     * The maximum number of nested JSON objects that a single document can contain across all nested types. This limit helps to prevent out of memory errors when a document contains too many nested objects. Default is 10000.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withMappingNestedObjectsLimit(long mappingNestedObjectsLimit) {
        Utils.checkNotNull(mappingNestedObjectsLimit, "mappingNestedObjectsLimit");
     ...
     * The maximum number of nested JSON objects that a single document can contain across all nested types. This limit helps to prevent out of memory errors when a document contains too many nested objects. Default is 10000.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withMappingNestedObjectsLimit(Optional<? extends Long> mappingNestedObjectsLimit) {
        Utils.checkNotNull(mappingNestedObjectsLimit, "mappingNestedObjectsLimit");
        this.mappingNestedObjectsLimit = mappingNestedObjectsLimit;
        return this;
    }
     ...
     * The number of replicas each primary shard has.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withNumberOfReplicas(long numberOfReplicas) {
        Utils.checkNotNull(numberOfReplicas, "numberOfReplicas");
     ...
     * The number of replicas each primary shard has.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withNumberOfReplicas(Optional<? extends Long> numberOfReplicas) {
        Utils.checkNotNull(numberOfReplicas, "numberOfReplicas");
        this.numberOfReplicas = numberOfReplicas;
        return this;
    }
     ...
     * The number of primary shards that an index should have.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withNumberOfShards(long numberOfShards) {
        Utils.checkNotNull(numberOfShards, "numberOfShards");
     ...
     * The number of primary shards that an index should have.
     */
    public UpdateDbaasServiceOpensearchIndexTemplate withNumberOfShards(Optional<? extends Long> numberOfShards) {
        Utils.checkNotNull(numberOfShards, "numberOfShards");
        this.numberOfShards = numberOfShards;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDbaasServiceOpensearchIndexTemplate other = (UpdateDbaasServiceOpensearchIndexTemplate) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateDbaasServiceOpensearchIndexTemplate.class,
    ...
    public final static class Builder {
        ...
        public UpdateDbaasServiceOpensearchIndexTemplate build() {
            return new UpdateDbaasServiceOpensearchIndexTemplate(
                mappingNestedObjectsLimit,
                numberOfReplicas,
                numberOfShards);
        }
