...
| `ElasticIps` | [`List<ElasticIp>`](../../doc/models/elastic-ip.md) | Optional | Instances Elastic IPs<br>**Constraints**: *Unique Items Required* | List<ElasticIp> getElasticIps() | setElasticIps(List<ElasticIp> elasticIps) |
| `Name` | `String` | Required | Instance Pool name<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255` | String getName() | setName(String name) |
...
| `DiskSize` | `long` | Required | Instances disk size in GB<br>**Constraints**: `>= 10`, `<= 50000` | long getDiskSize() | setDiskSize(long diskSize) |
