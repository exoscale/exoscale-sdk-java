...
public class LoadBalancerPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new LoadBalancerPostRequestBody and sets the default values.
     */
    public LoadBalancerPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a LoadBalancerPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static LoadBalancerPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new LoadBalancerPostRequestBody();
    }
    /**
