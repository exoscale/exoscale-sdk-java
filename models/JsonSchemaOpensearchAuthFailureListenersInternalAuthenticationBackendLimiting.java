...
public class JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimiting implements Parsable {
    /**
     ...
     */
    private JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingAuthenticationBackend authenticationBackend;
    /**
     ...
     */
    private JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingType type;
    /**
    ...
    public static JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimiting createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimiting();
    }
    /**
    ...
    /**
     * Gets the authentication_backend property value. The internal backend. Enter `internal`
     * @return a JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingAuthenticationBackend
     */
    @jakarta.annotation.Nullable
    public JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingAuthenticationBackend getAuthenticationBackend() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication_backend", (n) -> { this.setAuthenticationBackend(n.getEnumValue(JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingAuthenticationBackend::forValue)); });
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingType::forValue)); });
     ...
     * @return a JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingType
     */
    @jakarta.annotation.Nullable
    public JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingType getType() {
        return this.type;
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeEnumValue("authentication_backend", this.getAuthenticationBackend());
    ...
    /**
     * Sets the authentication_backend property value. The internal backend. Enter `internal`
     * @param value Value to set for the authentication_backend property.
     */
    public void setAuthenticationBackend(@jakarta.annotation.Nullable final JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingAuthenticationBackend value) {
        this.authenticationBackend = value;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final JsonSchemaOpensearchAuthFailureListenersInternalAuthenticationBackendLimitingType value) {
        this.type = value;
    }
}
