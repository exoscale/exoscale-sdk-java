...
/**
 * This is a model class for DbaasRedisRequest1 type.
 */
public class DbaasRedisRequest1 {
    ...
    /**
     * Converts this DbaasRedisRequest1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DbaasRedisRequest1 [" + "plan=" + plan + ", maintenance=" + maintenance
                + ", terminationProtection=" + terminationProtection + ", ipFilter=" + ipFilter
                + ", migration=" + migration + ", redisSettings=" + redisSettings
                + ", forkFromService=" + forkFromService + ", recoveryBackupName="
                + recoveryBackupName + "]";
    }

    /**
     * Builds a new {@link DbaasRedisRequest1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DbaasRedisRequest1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DbaasRedisRequest1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link DbaasRedisRequest1} object using the set fields.
         * @return {@link DbaasRedisRequest1}
         */
        public DbaasRedisRequest1 build() {
            return new DbaasRedisRequest1(plan, maintenance, terminationProtection, ipFilter,
                    migration, redisSettings, forkFromService, recoveryBackupName);
        }
    }
}
