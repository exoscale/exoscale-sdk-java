...
public class ElasticIpGetResponse implements AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    private Map<String, Object> additionalData;
    /**
     * The elasticIps property
     */
    private java.util.List<ElasticIp> elasticIps;
    /**
     * Instantiates a new ElasticIpGetResponse and sets the default values.
     */
    public ElasticIpGetResponse() {
    ...
    public static ElasticIpGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ElasticIpGetResponse();
    }
    /**
    ...
    /**
     * Gets the elastic-ips property value. The elasticIps property
    ...
    /**
     * Sets the elastic-ips property value. The elasticIps property
