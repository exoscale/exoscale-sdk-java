...
public class PrivateNetworkPutRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PrivateNetworkPutRequestBody and sets the default values.
     */
    public PrivateNetworkPutRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a PrivateNetworkPutRequestBody
     */
    @jakarta.annotation.Nonnull
    public static PrivateNetworkPutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PrivateNetworkPutRequestBody();
    }
    /**
