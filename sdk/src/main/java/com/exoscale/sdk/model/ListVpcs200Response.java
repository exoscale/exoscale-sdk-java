...
import com.exoscale.sdk.model.ListVpcResponseEntry;
...
public class ListVpcs200Response {
  ...
  private List<ListVpcResponseEntry> vpcs;

  public ListVpcs200Response() { 
  }

  public ListVpcs200Response vpcs(List<ListVpcResponseEntry> vpcs) {
    this.vpcs = vpcs;
    return this;
  }

  public ListVpcs200Response addVpcsItem(ListVpcResponseEntry vpcsItem) {
    if (this.vpcs == null) {
  ...
  **/
  ...
  public List<ListVpcResponseEntry> getVpcs() {
    return vpcs;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VPCS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVpcs(List<ListVpcResponseEntry> vpcs) {
    this.vpcs = vpcs;
  }
