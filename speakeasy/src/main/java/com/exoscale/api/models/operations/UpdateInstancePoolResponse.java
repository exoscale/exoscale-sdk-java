...
public class UpdateInstancePoolResponse implements com.exoscale.api.utils.Response {
    ...
    public UpdateInstancePoolResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public UpdateInstancePoolResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UpdateInstancePoolResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateInstancePoolResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * 200
     */
    public UpdateInstancePoolResponse withOperation(com.exoscale.api.models.components.Operation operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * 200
     */
    public UpdateInstancePoolResponse withOperation(Optional<? extends com.exoscale.api.models.components.Operation> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(UpdateInstancePoolResponse.class,
