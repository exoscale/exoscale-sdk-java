...
public class DbaasServicePgComponents implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasServicePgComponents and sets the default values.
     */
    public DbaasServicePgComponents() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasServicePgComponents
     */
    @jakarta.annotation.Nonnull
    public static DbaasServicePgComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasServicePgComponents();
    }
    /**
