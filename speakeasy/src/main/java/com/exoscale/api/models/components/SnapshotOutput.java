...
public class SnapshotOutput {
    ...
    private Optional<? extends InstanceOutput> instance;
    ...
    public SnapshotOutput(
            ...
            @JsonProperty("instance") Optional<? extends InstanceOutput> instance) {
     ...
     * Instance
     */
    public Optional<? extends InstanceOutput> instance() {
        return instance;
    }
     ...
     * Snapshot ID
     */
    public SnapshotOutput withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Snapshot ID
     */
    public SnapshotOutput withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Snapshot name
     */
    public SnapshotOutput withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Snapshot name
     */
    public SnapshotOutput withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Snapshot creation date
     */
    public SnapshotOutput withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * Snapshot creation date
     */
    public SnapshotOutput withCreatedAt(Optional<? extends OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Snapshot state
     */
    public SnapshotOutput withState(SnapshotState state) {
        Utils.checkNotNull(state, "state");
     ...
     * Snapshot state
     */
    public SnapshotOutput withState(Optional<? extends SnapshotState> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
     ...
     * Snapshot size in GB
     */
    public SnapshotOutput withSize(long size) {
        Utils.checkNotNull(size, "size");
     ...
     * Snapshot size in GB
     */
    public SnapshotOutput withSize(Optional<? extends Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * Exported snapshot information
     */
    public SnapshotOutput withExport(Export export) {
        Utils.checkNotNull(export, "export");
     ...
     * Exported snapshot information
     */
    public SnapshotOutput withExport(Optional<? extends Export> export) {
        Utils.checkNotNull(export, "export");
        this.export = export;
        return this;
    }
     ...
     * Instance
     */
    public SnapshotOutput withInstance(InstanceOutput instance) {
        Utils.checkNotNull(instance, "instance");
     ...
     * Instance
     */
    public SnapshotOutput withInstance(Optional<? extends InstanceOutput> instance) {
        Utils.checkNotNull(instance, "instance");
        this.instance = instance;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SnapshotOutput other = (SnapshotOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SnapshotOutput.class,
                "id", id,
                "name", name,
                "createdAt", createdAt,
                "state", state,
    ...
    public final static class Builder {
        ...
        private Optional<? extends InstanceOutput> instance = Optional.empty();  
         ...
         * Instance
         */
        public Builder instance(InstanceOutput instance) {
            Utils.checkNotNull(instance, "instance");
            this.instance = Optional.ofNullable(instance);
            return this;
        }
         ...
         * Instance
         */
        public Builder instance(Optional<? extends InstanceOutput> instance) {
            Utils.checkNotNull(instance, "instance");
            this.instance = instance;
            return this;
        }
