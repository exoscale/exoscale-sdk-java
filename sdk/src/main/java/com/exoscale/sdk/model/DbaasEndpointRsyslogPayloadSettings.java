 ...
 */
@JsonPropertyOrder({
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_FORMAT,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_KEY,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_LOGLINE,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_SERVER,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_CA,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_CERT,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_TLS,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_PORT,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_SD,
  DbaasEndpointRsyslogPayloadSettings.JSON_PROPERTY_MAX_MESSAGE_SIZE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.4.0")
public class DbaasEndpointRsyslogPayloadSettings {
  ...
  public DbaasEndpointRsyslogPayloadSettings() { 
  }

  public DbaasEndpointRsyslogPayloadSettings format(EnumRsyslogFormat format) {
    this.format = format;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings logline(String logline) {
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings server(String server) {
    this.server = server;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings ca(String ca) {
    this.ca = ca;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings cert(String cert) {
    this.cert = cert;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings tls(Boolean tls) {
    this.tls = tls;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings port(Long port) {
    this.port = port;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings sd(String sd) {
    this.sd = sd;
    return this;
  }
  ...
  **/
  ...
  public DbaasEndpointRsyslogPayloadSettings maxMessageSize(Long maxMessageSize) {
  ...
  **/
  ...
  /**
   * Return true if this dbaas_endpoint_rsyslog_payload_settings object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DbaasEndpointRsyslogPayloadSettings dbaasEndpointRsyslogPayloadSettings = (DbaasEndpointRsyslogPayloadSettings) o;
    return Objects.equals(this.format, dbaasEndpointRsyslogPayloadSettings.format) &&
        Objects.equals(this.key, dbaasEndpointRsyslogPayloadSettings.key) &&
        Objects.equals(this.logline, dbaasEndpointRsyslogPayloadSettings.logline) &&
        Objects.equals(this.server, dbaasEndpointRsyslogPayloadSettings.server) &&
        Objects.equals(this.ca, dbaasEndpointRsyslogPayloadSettings.ca) &&
        Objects.equals(this.cert, dbaasEndpointRsyslogPayloadSettings.cert) &&
        Objects.equals(this.tls, dbaasEndpointRsyslogPayloadSettings.tls) &&
        Objects.equals(this.port, dbaasEndpointRsyslogPayloadSettings.port) &&
        Objects.equals(this.sd, dbaasEndpointRsyslogPayloadSettings.sd) &&
        Objects.equals(this.maxMessageSize, dbaasEndpointRsyslogPayloadSettings.maxMessageSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class DbaasEndpointRsyslogPayloadSettings {\n");
