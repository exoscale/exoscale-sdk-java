...
public class DbaasServiceMysqlComponents implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasServiceMysqlComponents and sets the default values.
     */
    public DbaasServiceMysqlComponents() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a DbaasServiceMysqlComponents
     */
    @jakarta.annotation.Nonnull
    public static DbaasServiceMysqlComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasServiceMysqlComponents();
    }
    /**
