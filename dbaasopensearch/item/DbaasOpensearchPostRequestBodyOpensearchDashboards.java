...
public class DbaasOpensearchPostRequestBodyOpensearchDashboards implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasOpensearchPostRequestBodyOpensearchDashboards and sets the default values.
     */
    public DbaasOpensearchPostRequestBodyOpensearchDashboards() {
    ...
    public static DbaasOpensearchPostRequestBodyOpensearchDashboards createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasOpensearchPostRequestBodyOpensearchDashboards();
    }
    /**
