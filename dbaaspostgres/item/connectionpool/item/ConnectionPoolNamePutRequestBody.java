...
public class ConnectionPoolNamePutRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ConnectionPoolNamePutRequestBody and sets the default values.
     */
    public ConnectionPoolNamePutRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ConnectionPoolNamePutRequestBody
     */
    @jakarta.annotation.Nonnull
    public static ConnectionPoolNamePutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ConnectionPoolNamePutRequestBody();
    }
    /**
