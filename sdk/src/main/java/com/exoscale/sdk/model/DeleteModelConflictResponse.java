 ...
 */
@JsonPropertyOrder({
  DeleteModelConflictResponse.JSON_PROPERTY_DEPLOYMENTS
})
...
public class DeleteModelConflictResponse {
  ...
  **/
  ...
  /**
   * Return true if this delete-model-conflict-response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DeleteModelConflictResponse deleteModelConflictResponse = (DeleteModelConflictResponse) o;
    return Objects.equals(this.deployments, deleteModelConflictResponse.deployments);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteModelConflictResponse {\n");
    ...
    if (getDeployments() != null) {
      for (int i = 0; i < getDeployments().size(); i++) {
        joiner.add(String.format("%sdeployments%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(String.valueOf(getDeployments().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
