...
/**
 * This is a model class for User6 type.
 */
public class User6 {
    ...
    /**
     * Converts this User6 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "User6 [" + "username=" + username + ", allowReplication=" + allowReplication + "]";
    }

    /**
     * Builds a new {@link User6.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link User6.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link User6}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link User6} object using the set fields.
         * @return {@link User6}
         */
        public User6 build() {
            return new User6(username, allowReplication);
        }
    }
}
