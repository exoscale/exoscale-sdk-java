...
public class WithNamePutRequestBodyMigration implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new WithNamePutRequestBodyMigration and sets the default values.
     */
    public WithNamePutRequestBodyMigration() {
    ...
    public static WithNamePutRequestBodyMigration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WithNamePutRequestBodyMigration();
    }
    /**
