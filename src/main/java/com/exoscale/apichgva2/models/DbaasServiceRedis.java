...
/**
 * This is a model class for DbaasServiceRedis type.
 */
public class DbaasServiceRedis {
    private LocalDateTime updatedAt;
    private Long nodeCount;
    private ConnectionInfo4 connectionInfo;
    ...
    private List<Component4> components;
     ...
     * @param  connectionInfo  ConnectionInfo4 value for connectionInfo.
     ...
     * @param  components  List of Component4 value for components.
     ...
     * @param  users  List of User4 value for users.
     */
    public DbaasServiceRedis(
            String name,
            String type,
     ...
     * @return Returns the ConnectionInfo4
     */
    @JsonGetter("connection-info")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ConnectionInfo4 getConnectionInfo() {
     ...
     * Redis connection information properties
     * @param connectionInfo Value for ConnectionInfo4
     */
    @JsonSetter("connection-info")
    public void setConnectionInfo(ConnectionInfo4 connectionInfo) {
        this.connectionInfo = connectionInfo;
    }
     ...
     * @return Returns the List of Component4
     */
     ...
     * Service component information objects
     * @param components Value for List of Component4
     */
    @JsonSetter("components")
    public void setComponents(List<Component4> components) {
        this.components = components;
    }
     ...
     * @return Returns the List of User4
     */
    @JsonGetter("users")
    @JsonInclude(JsonInclude.Include.NON_NULL)
     ...
     * Setter for Users.
     * List of service users
     * @param users Value for List of User4
     */
    @JsonSetter("users")
    ...
    /**
     * Converts this DbaasServiceRedis into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DbaasServiceRedis [" + "name=" + name + ", type=" + type + ", plan=" + plan
                ...
                + ", redisSettings=" + redisSettings + ", state=" + state + ", ipFilter=" + ipFilter
                + ", backups=" + backups + ", terminationProtection=" + terminationProtection
                + ", notifications=" + notifications + ", components=" + components
                + ", maintenance=" + maintenance + ", diskSize=" + diskSize + ", nodeMemory="
                + nodeMemory + ", uri=" + uri + ", uriParams=" + uriParams + ", version=" + version
                + ", createdAt=" + createdAt + ", users=" + users + "]";
    }

    /**
     * Builds a new {@link DbaasServiceRedis.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DbaasServiceRedis.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DbaasServiceRedis}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder connectionInfo(ConnectionInfo4 connectionInfo) {
            this.connectionInfo = connectionInfo;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder components(List<Component4> components) {
            this.components = components;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder users(List<User4> users) {
            this.users = users;
            return this;
        }

        /**
         * Builds a new {@link DbaasServiceRedis} object using the set fields.
         * @return {@link DbaasServiceRedis}
         */
        public DbaasServiceRedis build() {
            return new DbaasServiceRedis(name, type, plan, updatedAt, nodeCount, connectionInfo,
                    nodeCpuCount, integrations, zone, nodeStates, redisSettings, state, ipFilter,
                    backups, terminationProtection, notifications, components, maintenance,
                    diskSize, nodeMemory, uri, uriParams, version, createdAt, users);
        }
    }
}
