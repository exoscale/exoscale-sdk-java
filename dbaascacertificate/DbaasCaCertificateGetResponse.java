...
public class DbaasCaCertificateGetResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasCaCertificateGetResponse and sets the default values.
     */
    public DbaasCaCertificateGetResponse() {
    ...
    public static DbaasCaCertificateGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasCaCertificateGetResponse();
    }
    /**
