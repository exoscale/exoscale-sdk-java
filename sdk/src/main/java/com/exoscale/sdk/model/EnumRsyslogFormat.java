...
/**
 * Gets or Sets enum-rsyslog-format
 */
public enum EnumRsyslogFormat {
  ...
  EnumRsyslogFormat(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EnumRsyslogFormat fromValue(String value) {
    for (EnumRsyslogFormat b : EnumRsyslogFormat.values()) {
