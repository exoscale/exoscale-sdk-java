...
public class Pg {
    ...
    private Optional<? extends GetDbaasSettingsPgProperties> properties;
    ...
    public Pg(
            @JsonProperty("properties") Optional<? extends GetDbaasSettingsPgProperties> properties,
    ...
    public Optional<? extends GetDbaasSettingsPgProperties> properties() {
        return properties;
    }
    ...
    public Pg withProperties(GetDbaasSettingsPgProperties properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = Optional.ofNullable(properties);
        return this;
    }

    public Pg withProperties(Optional<? extends GetDbaasSettingsPgProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public Pg withAdditionalProperties(boolean additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = Optional.ofNullable(additionalProperties);
        return this;
    }

    public Pg withAdditionalProperties(Optional<? extends Boolean> additionalProperties) {
        Utils.checkNotNull(additionalProperties, "additionalProperties");
        this.additionalProperties = additionalProperties;
        return this;
    }

    public Pg withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Pg withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Pg withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }

    public Pg withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Pg.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetDbaasSettingsPgProperties> properties = Optional.empty();
        ...
        public Builder properties(GetDbaasSettingsPgProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = Optional.ofNullable(properties);
            return this;
        }

        public Builder properties(Optional<? extends GetDbaasSettingsPgProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
