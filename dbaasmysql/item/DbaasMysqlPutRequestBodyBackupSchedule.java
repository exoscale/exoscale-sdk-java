...
public class DbaasMysqlPutRequestBodyBackupSchedule implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasMysqlPutRequestBodyBackupSchedule and sets the default values.
     */
    public DbaasMysqlPutRequestBodyBackupSchedule() {
    ...
    public static DbaasMysqlPutRequestBodyBackupSchedule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasMysqlPutRequestBodyBackupSchedule();
    }
    /**
