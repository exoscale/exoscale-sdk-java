...
public class DbaasPostgresPutRequestBodyBackupSchedule implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasPostgresPutRequestBodyBackupSchedule and sets the default values.
     */
    public DbaasPostgresPutRequestBodyBackupSchedule() {
    ...
    public static DbaasPostgresPutRequestBodyBackupSchedule createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DbaasPostgresPutRequestBodyBackupSchedule();
    }
    /**
