...
- Build date: 2024-05-06T14:27:11.860946+02:00[Europe/Vienna]
...
public class NewInstanceExample {
    ...
    CreateInstanceRequest request = new CreateInstanceRequest().instanceType(instanceType).template(template).diskSize(50L).publicIpAssignment(PublicIpAssignment.INET4);
