...
public class Components {
     ...
     * Service component name
     */
    public Components withComponent(String component) {
        Utils.checkNotNull(component, "component");
        this.component = component;
        return this;
    }
     ...
     * DNS name for connecting to the service component
     */
    public Components withHost(String host) {
        Utils.checkNotNull(host, "host");
        this.host = host;
        return this;
    }
     ...
     * Port number for connecting to the service component
     */
    public Components withPort(long port) {
        Utils.checkNotNull(port, "port");
        this.port = port;
        return this;
    }

    public Components withRoute(EnumComponentRoute route) {
        Utils.checkNotNull(route, "route");
        this.route = route;
        return this;
    }

    public Components withUsage(EnumComponentUsage usage) {
        Utils.checkNotNull(usage, "usage");
        this.usage = usage;
        return this;
    }
