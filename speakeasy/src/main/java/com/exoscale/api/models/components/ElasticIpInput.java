...
/**
 * ElasticIpInput - Elastic IP
 */

public class ElasticIpInput {
     ...
     * Elastic IP description
     */
    public ElasticIpInput withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * Elastic IP description
     */
    public ElasticIpInput withDescription(Optional<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Elastic IP address healthcheck
     */
    public ElasticIpInput withHealthcheck(ElasticIpHealthcheck healthcheck) {
        Utils.checkNotNull(healthcheck, "healthcheck");
     ...
     * Elastic IP address healthcheck
     */
    public ElasticIpInput withHealthcheck(Optional<? extends ElasticIpHealthcheck> healthcheck) {
        Utils.checkNotNull(healthcheck, "healthcheck");
        this.healthcheck = healthcheck;
        return this;
    }

    public ElasticIpInput withLabels(java.util.Map<String, String> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = Optional.ofNullable(labels);
        return this;
    }

    public ElasticIpInput withLabels(Optional<? extends java.util.Map<String, String>> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = labels;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ElasticIpInput other = (ElasticIpInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ElasticIpInput.class,
    ...
    public final static class Builder {
        ...
        public ElasticIpInput build() {
            return new ElasticIpInput(
                description,
                healthcheck,
                labels);
        }
