...
public class DbaasIntegrationTypeSettings implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DbaasIntegrationTypeSettingsProperties properties;
    /**
     * The title property
     */
    ...
    private String type;
    /**
     * Instantiates a new DbaasIntegrationTypeSettings and sets the default values.
     */
    ...
    public static DbaasIntegrationTypeSettings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("properties", (n) -> { this.setProperties(n.getObjectValue(DbaasIntegrationTypeSettingsProperties::createFromDiscriminatorValue)); });
     ...
     * @return a DbaasIntegrationTypeSettingsProperties
     */
    @jakarta.annotation.Nullable
    public DbaasIntegrationTypeSettingsProperties getProperties() {
     ...
     */
    public void setProperties(@jakarta.annotation.Nullable final DbaasIntegrationTypeSettingsProperties value) {
