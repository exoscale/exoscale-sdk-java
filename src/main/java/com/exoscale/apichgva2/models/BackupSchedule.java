...
/**
 * This is a model class for BackupSchedule type.
 */
public class BackupSchedule {
    ...
    /**
     * Converts this BackupSchedule into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BackupSchedule [" + "backupHour=" + backupHour + ", backupMinute=" + backupMinute
                + "]";
    }

    /**
     * Builds a new {@link BackupSchedule.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BackupSchedule.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BackupSchedule}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BackupSchedule} object using the set fields.
         * @return {@link BackupSchedule}
         */
        public BackupSchedule build() {
            return new BackupSchedule(backupHour, backupMinute);
        }
    }
}
