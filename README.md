...
- Build date: 2026-08-19T07:19:29.320811657Z[Etc/UTC]
...
<dependency>
    ...
    <version>0.0.5-SNAPSHOT-7173a70</version>
</dependency>
```
...
dependencies {
  implementation 'com.exoscale.sdk:sdk:0.0.5-SNAPSHOT-7173a70'
}
```
...
*ExoscaleApi* | [**createDbaasClickhouseUser**](sdk/docs/ExoscaleApi.md#createDbaasClickhouseUser) | **POST** /dbaas-clickhouse/{service-name}/user | Create a DBaaS ClickHouse user
...
*ExoscaleApi* | [**createDbaasServiceClickhouse**](sdk/docs/ExoscaleApi.md#createDbaasServiceClickhouse) | **POST** /dbaas-clickhouse/{name} | Create a DBaaS ClickHouse service
...
*ExoscaleApi* | [**createDeployment**](sdk/docs/ExoscaleApi.md#createDeployment) | **POST** /ai/deployment | Create Deployment
...
*ExoscaleApi* | [**deleteDbaasClickhouseRole**](sdk/docs/ExoscaleApi.md#deleteDbaasClickhouseRole) | **DELETE** /dbaas-clickhouse/{service-name}/role/{role-uuid} | Delete a DBaaS ClickHouse role
*ExoscaleApi* | [**deleteDbaasClickhouseUser**](sdk/docs/ExoscaleApi.md#deleteDbaasClickhouseUser) | **DELETE** /dbaas-clickhouse/{service-name}/user/{user-uuid} | Delete a DBaaS ClickHouse user
...
*ExoscaleApi* | [**deleteDbaasServiceClickhouse**](sdk/docs/ExoscaleApi.md#deleteDbaasServiceClickhouse) | **DELETE** /dbaas-clickhouse/{name} | Delete a ClickHouse service
...
*ExoscaleApi* | [**deleteDeployment**](sdk/docs/ExoscaleApi.md#deleteDeployment) | **DELETE** /ai/deployment/{id} | Delete Deployment
...
*ExoscaleApi* | [**getDbaasClickhouseAclConfig**](sdk/docs/ExoscaleApi.md#getDbaasClickhouseAclConfig) | **GET** /dbaas-clickhouse/{service-name}/acl-config | Get DBaaS ClickHouse ACL configuration
...
*ExoscaleApi* | [**getDbaasServiceClickhouse**](sdk/docs/ExoscaleApi.md#getDbaasServiceClickhouse) | **GET** /dbaas-clickhouse/{name} | Get a DBaaS ClickHouse service
...
*ExoscaleApi* | [**getDeployment**](sdk/docs/ExoscaleApi.md#getDeployment) | **GET** /ai/deployment/{id} | Get Deployment
*ExoscaleApi* | [**getDeploymentLogs**](sdk/docs/ExoscaleApi.md#getDeploymentLogs) | **GET** /ai/deployment/{id}/logs | Get Deployment Logs
...
*ExoscaleApi* | [**getImpactReport**](sdk/docs/ExoscaleApi.md#getImpactReport) | **GET** /environmental-impact/report | [BETA] Get an environmental impact report
*ExoscaleApi* | [**getInferenceEngineHelp**](sdk/docs/ExoscaleApi.md#getInferenceEngineHelp) | **GET** /ai/help/inference-engine-parameters | Get inference-engine Help
...
*ExoscaleApi* | [**listDbaasClickhouseRoles**](sdk/docs/ExoscaleApi.md#listDbaasClickhouseRoles) | **GET** /dbaas-clickhouse/{service-name}/role | List DBaaS ClickHouse roles
*ExoscaleApi* | [**listDbaasClickhouseUsers**](sdk/docs/ExoscaleApi.md#listDbaasClickhouseUsers) | **GET** /dbaas-clickhouse/{service-name}/user | List DBaaS ClickHouse users
...
*ExoscaleApi* | [**listDbaasValkeyUsers**](sdk/docs/ExoscaleApi.md#listDbaasValkeyUsers) | **GET** /dbaas-valkey/{service-name}/user | List DBaaS Valkey users with ACL configuration
*ExoscaleApi* | [**listDeployTargets**](sdk/docs/ExoscaleApi.md#listDeployTargets) | **GET** /deploy-target | List Deploy Targets
*ExoscaleApi* | [**listDeployments**](sdk/docs/ExoscaleApi.md#listDeployments) | **GET** /ai/deployment | List Deployments
...
*ExoscaleApi* | [**resetDbaasClickhouseUserPassword**](sdk/docs/ExoscaleApi.md#resetDbaasClickhouseUserPassword) | **PUT** /dbaas-clickhouse/{service-name}/user/{username}/password/reset | Reset the credentials of a DBaaS ClickHouse user
...
*ExoscaleApi* | [**revealDbaasClickhouseUserPassword**](sdk/docs/ExoscaleApi.md#revealDbaasClickhouseUserPassword) | **GET** /dbaas-clickhouse/{service-name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS ClickHouse user
...
*ExoscaleApi* | [**scaleDeployment**](sdk/docs/ExoscaleApi.md#scaleDeployment) | **POST** /ai/deployment/{id}/scale | Scale Deployment
...
*ExoscaleApi* | [**updateDbaasServiceClickhouse**](sdk/docs/ExoscaleApi.md#updateDbaasServiceClickhouse) | **PUT** /dbaas-clickhouse/{name} | Update a DBaaS ClickHouse service
...
*ExoscaleApi* | [**updateDbaasValkeyUserAccessControl**](sdk/docs/ExoscaleApi.md#updateDbaasValkeyUserAccessControl) | **PUT** /dbaas-valkey/{service-name}/user/{username} | Update access control for one DBaaS Valkey service user
*ExoscaleApi* | [**updateDeployment**](sdk/docs/ExoscaleApi.md#updateDeployment) | **PATCH** /ai/deployment/{id} | Update Deployment
...
## Documentation for Models
 ...
 - [CreateDbaasValkeyUserRequest](sdk/docs/CreateDbaasValkeyUserRequest.md)
 ...
 - [DbaasValkeyUser](sdk/docs/DbaasValkeyUser.md)
 - [DbaasValkeyUserAccessControl](sdk/docs/DbaasValkeyUserAccessControl.md)
 - [DbaasValkeyUsers](sdk/docs/DbaasValkeyUsers.md)
 - [DecryptRequest](sdk/docs/DecryptRequest.md)
 - [DecryptResponse](sdk/docs/DecryptResponse.md)
 ...
 - [DisableKmsKeyRotationResponse](sdk/docs/DisableKmsKeyRotationResponse.md)
 ...
 - [EnableKmsKeyRotationRequest](sdk/docs/EnableKmsKeyRotationRequest.md)
 - [EnableKmsKeyRotationResponse](sdk/docs/EnableKmsKeyRotationResponse.md)
 - [EncryptRequest](sdk/docs/EncryptRequest.md)
 - [EncryptResponse](sdk/docs/EncryptResponse.md)
 ...
 - [ImpactValueWithUnit](sdk/docs/ImpactValueWithUnit.md)
 ...
 - [IngestMeteringRequest](sdk/docs/IngestMeteringRequest.md)
 - [IngestMeteringResponse](sdk/docs/IngestMeteringResponse.md)
 ...
 - [ListKmsKeysResponseEntry](sdk/docs/ListKmsKeysResponseEntry.md)
 ...
 - [ReEncryptResponse](sdk/docs/ReEncryptResponse.md)
 - [RecomputeBundleResponse](sdk/docs/RecomputeBundleResponse.md)
 ...
 - [SubnetInstancesInner](sdk/docs/SubnetInstancesInner.md)
 ...
 - [UpdateDbaasValkeyUserAccessControlRequest](sdk/docs/UpdateDbaasValkeyUserAccessControlRequest.md)
