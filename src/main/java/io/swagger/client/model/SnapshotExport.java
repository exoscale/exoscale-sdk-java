 ...
 */
@Schema(description = "Exported snapshot information")
...
public class SnapshotExport {
   ...
   * @return presignedUrl
  **/
  @Schema(description = "Exported snapshot disk file pre-signed URL")
   ...
   * @return md5sum
  **/
  @Schema(description = "Exported snapshot disk file MD5 checksum")
