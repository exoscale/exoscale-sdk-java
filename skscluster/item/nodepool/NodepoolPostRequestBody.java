...
import com.exoscale.models.KubeletImageGc;
...
public class NodepoolPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Nodepool addons
     */
    private java.util.List<NodepoolPostRequestBodyAddons> addons;
    /**
    ...
    /**
     * Instantiates a new NodepoolPostRequestBody and sets the default values.
     */
    public NodepoolPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a NodepoolPostRequestBody
     */
    @jakarta.annotation.Nonnull
    public static NodepoolPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new NodepoolPostRequestBody();
    }
    /**
     ...
     * @return a java.util.List<NodepoolPostRequestBodyAddons>
     */
    @jakarta.annotation.Nullable
    public java.util.List<NodepoolPostRequestBodyAddons> getAddons() {
        return this.addons;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("addons", (n) -> { this.setAddons(n.getCollectionOfEnumValues(NodepoolPostRequestBodyAddons::forValue)); });
     ...
     */
    public void setAddons(@jakarta.annotation.Nullable final java.util.List<NodepoolPostRequestBodyAddons> value) {
        this.addons = value;
    }
    /**
