...
public class UpdateInstanceRequestBuilder {
    ...
    public UpdateInstanceRequestBuilder id(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public UpdateInstanceRequestBuilder requestBody(UpdateInstanceRequestBody requestBody) {
