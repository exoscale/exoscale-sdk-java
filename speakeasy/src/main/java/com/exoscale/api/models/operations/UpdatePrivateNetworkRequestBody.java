...
public class UpdatePrivateNetworkRequestBody {
    ...
    public UpdatePrivateNetworkRequestBody(
     ...
     * Private Network name
     */
    public UpdatePrivateNetworkRequestBody withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Private Network name
     */
    public UpdatePrivateNetworkRequestBody withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Private Network description
     */
    public UpdatePrivateNetworkRequestBody withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * Private Network description
     */
    public UpdatePrivateNetworkRequestBody withDescription(Optional<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Private Network netmask
     */
    public UpdatePrivateNetworkRequestBody withNetmask(String netmask) {
        Utils.checkNotNull(netmask, "netmask");
     ...
     * Private Network netmask
     */
    public UpdatePrivateNetworkRequestBody withNetmask(Optional<? extends String> netmask) {
        Utils.checkNotNull(netmask, "netmask");
        this.netmask = netmask;
        return this;
    }
     ...
     * Private Network start IP address
     */
    public UpdatePrivateNetworkRequestBody withStartIp(String startIp) {
        Utils.checkNotNull(startIp, "startIp");
     ...
     * Private Network start IP address
     */
    public UpdatePrivateNetworkRequestBody withStartIp(Optional<? extends String> startIp) {
        Utils.checkNotNull(startIp, "startIp");
        this.startIp = startIp;
        return this;
    }
     ...
     * Private Network end IP address
     */
    public UpdatePrivateNetworkRequestBody withEndIp(String endIp) {
        Utils.checkNotNull(endIp, "endIp");
     ...
     * Private Network end IP address
     */
    public UpdatePrivateNetworkRequestBody withEndIp(Optional<? extends String> endIp) {
        Utils.checkNotNull(endIp, "endIp");
        this.endIp = endIp;
        return this;
    }

    public UpdatePrivateNetworkRequestBody withLabels(java.util.Map<String, String> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = Optional.ofNullable(labels);
        return this;
    }

    public UpdatePrivateNetworkRequestBody withLabels(Optional<? extends java.util.Map<String, String>> labels) {
        Utils.checkNotNull(labels, "labels");
        this.labels = labels;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePrivateNetworkRequestBody other = (UpdatePrivateNetworkRequestBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePrivateNetworkRequestBody.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public UpdatePrivateNetworkRequestBody build() {
            return new UpdatePrivateNetworkRequestBody(
                name,
                description,
                netmask,
                startIp,
