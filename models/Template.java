...
public class Template implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private TemplateBootMode bootMode;
    /**
     * Template build
     */
     ...
     * @return a TemplateBootMode
     */
    @jakarta.annotation.Nullable
    public TemplateBootMode getBootMode() {
    ...
    /**
     * Gets the created-at property value. Template creation date
    ...
    /**
     * Gets the family property value. Template family
     * @return a String
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("boot-mode", (n) -> { this.setBootMode(n.getEnumValue(TemplateBootMode::forValue)); });
        ...
        deserializerMap.put("family", (n) -> { this.setFamily(n.getStringValue()); });
        ...
        deserializerMap.put("visibility", (n) -> { this.setVisibility(n.getEnumValue(TemplateVisibility::forValue)); });
        deserializerMap.put("zones", (n) -> { this.setZones(n.getCollectionOfEnumValues(ZoneName::forValue)); });
        return deserializerMap;
    }
    /**
     * Gets the id property value. Template ID
     * @return a UUID
     */
    @jakarta.annotation.Nullable
    public UUID getId() {
    ...
    /**
     * Gets the visibility property value. Template visibility
     * @return a TemplateVisibility
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the zones property value. Zones availability
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeCollectionOfEnumValues("zones", this.getZones());
     ...
     */
    public void setBootMode(@jakarta.annotation.Nullable final TemplateBootMode value) {
        this.bootMode = value;
    }
    /**
    ...
    /**
     * Sets the created-at property value. Template creation date
    ...
    /**
     * Sets the family property value. Template family
     * @param value Value to set for the family property.
     */
    public void setFamily(@jakarta.annotation.Nullable final String value) {
        this.family = value;
    }
    /**
     * Sets the id property value. Template ID
    ...
    /**
     * Sets the visibility property value. Template visibility
     * @param value Value to set for the visibility property.
     */
    public void setVisibility(@jakarta.annotation.Nullable final TemplateVisibility value) {
        this.visibility = value;
    }
    /**
     * Sets the zones property value. Zones availability
