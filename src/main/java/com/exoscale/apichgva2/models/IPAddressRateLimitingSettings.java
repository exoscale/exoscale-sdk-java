...
/**
 * This is a model class for IPAddressRateLimitingSettings type.
 */
public class IPAddressRateLimitingSettings {
    private IpRateLimitingTypeEnum type;
     ...
     * @param  type  IpRateLimitingTypeEnum value for type.
     ...
     * @return Returns the IpRateLimitingTypeEnum
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public IpRateLimitingTypeEnum getType() {
        return type;
    }
     ...
     * Setter for Type.
     * The type of rate limiting
     * @param type Value for IpRateLimitingTypeEnum
     */
    @JsonSetter("type")
    public void setType(IpRateLimitingTypeEnum type) {
        this.type = type;
    }
    ...
    /**
     * Converts this IPAddressRateLimitingSettings into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "IPAddressRateLimitingSettings [" + "type=" + type + ", allowedTries=" + allowedTries
                + ", timeWindowSeconds=" + timeWindowSeconds + ", blockExpirySeconds="
                + blockExpirySeconds + ", maxBlockedClients=" + maxBlockedClients
                + ", maxTrackedClients=" + maxTrackedClients + "]";
    }

    /**
     * Builds a new {@link IPAddressRateLimitingSettings.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link IPAddressRateLimitingSettings.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link IPAddressRateLimitingSettings}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(IpRateLimitingTypeEnum type) {
            this.type = type;
            return this;
        }
        ...
        /**
         * Builds a new {@link IPAddressRateLimitingSettings} object using the set fields.
         * @return {@link IPAddressRateLimitingSettings}
         */
        public IPAddressRateLimitingSettings build() {
            return new IPAddressRateLimitingSettings(type, allowedTries, timeWindowSeconds,
                    blockExpirySeconds, maxBlockedClients, maxTrackedClients);
        }
    }
}
