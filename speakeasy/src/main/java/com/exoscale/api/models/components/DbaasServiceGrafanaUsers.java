...
public class DbaasServiceGrafanaUsers {
    ...
    public DbaasServiceGrafanaUsers withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public DbaasServiceGrafanaUsers withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public DbaasServiceGrafanaUsers withUsername(String username) {
        Utils.checkNotNull(username, "username");
        this.username = Optional.ofNullable(username);
        return this;
    }

    public DbaasServiceGrafanaUsers withUsername(Optional<? extends String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }

    public DbaasServiceGrafanaUsers withPassword(String password) {
        Utils.checkNotNull(password, "password");
        this.password = Optional.ofNullable(password);
        return this;
    }

    public DbaasServiceGrafanaUsers withPassword(Optional<? extends String> password) {
        Utils.checkNotNull(password, "password");
        this.password = password;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DbaasServiceGrafanaUsers other = (DbaasServiceGrafanaUsers) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DbaasServiceGrafanaUsers.class,
                "type", type,
                "username", username,
                "password", password);
    }
    ...
    public final static class Builder {
        ...
        public DbaasServiceGrafanaUsers build() {
