...
public class RecordPostRequestBody implements AdditionalDataHolder, Parsable {
     ...
     */
    private RecordPostRequestBodyType type;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(RecordPostRequestBodyType::forValue)); });
     ...
     * @return a RecordPostRequestBodyType
     */
    @jakarta.annotation.Nullable
    public RecordPostRequestBodyType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final RecordPostRequestBodyType value) {
        this.type = value;
    }
}
