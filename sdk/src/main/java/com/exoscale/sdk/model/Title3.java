 ...
 */
@JsonPropertyOrder({
  Title3.JSON_PROPERTY_GPU_COUNT,
  Title3.JSON_PROPERTY_UPDATED_AT,
  Title3.JSON_PROPERTY_DEPLOYMENT_URL,
  Title3.JSON_PROPERTY_SERVICE_LEVEL,
  Title3.JSON_PROPERTY_NAME,
  Title3.JSON_PROPERTY_STATUS_DETAILS,
  Title3.JSON_PROPERTY_GPU_TYPE,
  Title3.JSON_PROPERTY_STATUS,
  Title3.JSON_PROPERTY_ID,
  Title3.JSON_PROPERTY_REPLICAS,
  Title3.JSON_PROPERTY_CREATED_AT,
  Title3.JSON_PROPERTY_INFERENCE_ENGINE_PARAMETERS,
  Title3.JSON_PROPERTY_MODEL
})
...
public class Title3 {
  ...
  public static final String JSON_PROPERTY_STATUS_DETAILS = "status-details";
  private JsonNullable<Object> statusDetails = JsonNullable.<Object>of(null);
  ...
  public Title3 gpuCount(Object gpuCount) {
  ...
  **/
  ...
  public Title3 deploymentUrl(Object deploymentUrl) {
  ...
  **/
  ...
  public Title3 serviceLevel(Object serviceLevel) {
  ...
  **/
  ...
  public Title3 name(Object name) {
  ...
  **/
  ...
  public Title3 statusDetails(Object statusDetails) {
    this.statusDetails = JsonNullable.<Object>of(statusDetails);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<Object> getStatusDetails_JsonNullable() {
    return statusDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_STATUS_DETAILS)
  public void setStatusDetails_JsonNullable(JsonNullable<Object> statusDetails) {
  ...
  public Title3 gpuType(Object gpuType) {
  ...
  **/
  ...
  public Title3 status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public Title3 replicas(Object replicas) {
  ...
  **/
  ...
  public Title3 inferenceEngineParameters(List<Object> inferenceEngineParameters) {
    this.inferenceEngineParameters = inferenceEngineParameters;
    return this;
  }

  public Title3 addInferenceEngineParametersItem(Object inferenceEngineParametersItem) {
  ...
  **/
  ...
  public Title3 model(Title3Model model) {
    this.model = model;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this title_3 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.gpuCount, title3.gpuCount) &&
        equalsNullable(this.updatedAt, title3.updatedAt) &&
        equalsNullable(this.deploymentUrl, title3.deploymentUrl) &&
        equalsNullable(this.serviceLevel, title3.serviceLevel) &&
        equalsNullable(this.name, title3.name) &&
        equalsNullable(this.statusDetails, title3.statusDetails) &&
        equalsNullable(this.gpuType, title3.gpuType) &&
        Objects.equals(this.status, title3.status) &&
        equalsNullable(this.id, title3.id) &&
        equalsNullable(this.replicas, title3.replicas) &&
        equalsNullable(this.createdAt, title3.createdAt) &&
        Objects.equals(this.inferenceEngineParameters, title3.inferenceEngineParameters) &&
        Objects.equals(this.model, title3.model);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(gpuCount), hashCodeNullable(updatedAt), hashCodeNullable(deploymentUrl), hashCodeNullable(serviceLevel), hashCodeNullable(name), hashCodeNullable(statusDetails), hashCodeNullable(gpuType), status, hashCodeNullable(id), hashCodeNullable(replicas), hashCodeNullable(createdAt), inferenceEngineParameters, model);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `status-details` to the URL query string
    if (getStatusDetails() != null) {
      joiner.add(String.format("%sstatus-details%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStatusDetails()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
