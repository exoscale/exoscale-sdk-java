...
public class DbaasServiceRedisComponents implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new DbaasServiceRedisComponents and sets the default values.
     */
     ...
     * @return a DbaasServiceRedisComponents
     */
    @jakarta.annotation.Nonnull
    public static DbaasServiceRedisComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the ssl property value. Whether the endpoint is encrypted or accepts plaintext.             By default endpoints are always encrypted and             this property is only included for service components that may disable encryption.
     * @return a Boolean
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the ssl property value. Whether the endpoint is encrypted or accepts plaintext.             By default endpoints are always encrypted and             this property is only included for service components that may disable encryption.
