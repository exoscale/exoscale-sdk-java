...
public class Labels implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static Labels createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
