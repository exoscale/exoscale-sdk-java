...
public class UpdateElasticIpResponse implements com.exoscale.api.utils.Response {
    ...
    public UpdateElasticIpResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response status code for this operation
     */
    public UpdateElasticIpResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateElasticIpResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * 200
     */
    public UpdateElasticIpResponse withOperation(com.exoscale.api.models.components.Operation operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * 200
     */
    public UpdateElasticIpResponse withOperation(Optional<? extends com.exoscale.api.models.components.Operation> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateElasticIpResponse other = (UpdateElasticIpResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateElasticIpResponse.class,
    ...
    public final static class Builder {
        ...
        public UpdateElasticIpResponse build() {
            return new UpdateElasticIpResponse(
                contentType,
                statusCode,
                rawResponse,
                operation);
