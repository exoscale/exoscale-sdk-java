...
public class DbaasUserKafkaSecrets {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DbaasUserKafkaSecrets
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DbaasUserKafkaSecrets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DbaasUserKafkaSecrets is not found in the empty JSON string", DbaasUserKafkaSecrets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DbaasUserKafkaSecrets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DbaasUserKafkaSecrets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DbaasUserKafkaSecrets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DbaasUserKafkaSecrets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DbaasUserKafkaSecrets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DbaasUserKafkaSecrets.class));

       return (TypeAdapter<T>) new TypeAdapter<DbaasUserKafkaSecrets>() {
           @Override
           public void write(JsonWriter out, DbaasUserKafkaSecrets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DbaasUserKafkaSecrets read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DbaasUserKafkaSecrets given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DbaasUserKafkaSecrets
  * @throws IOException if the JSON string is invalid with respect to DbaasUserKafkaSecrets
  */
  public static DbaasUserKafkaSecrets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DbaasUserKafkaSecrets.class);
  }

 /**
  * Convert an instance of DbaasUserKafkaSecrets to an JSON string
  *
  * @return JSON string
  */
