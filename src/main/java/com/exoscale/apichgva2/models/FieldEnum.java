...
/**
 * FieldEnum to be used.
 */
public enum FieldEnum {
    DESCRIPTION;


    private static TreeMap<String, FieldEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static FieldEnum constructFromString(String toConvert) throws IOException {
        FieldEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
